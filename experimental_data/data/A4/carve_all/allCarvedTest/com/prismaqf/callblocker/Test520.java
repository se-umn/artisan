...
public class Test520 {
    ...
    public void test_com_prismaqf_callblocker_NewEditFilter_onOptionsItemSelected_002() throws Exception {
        ...
        org.mockito.stubbing.Stubber stubber58 = org.mockito.Mockito.doReturn("My calendar rule for testing");
        com.prismaqf.callblocker.filters.FilterHandle filterhandle56 = stubber58.when(filterhandle55);
        filterhandle56.getCalendarRuleName();
        ...
        org.robolectric.android.controller.ActivityController activitycontroller42 = org.robolectric.Robolectric.buildActivity(com.prismaqf.callblocker.NewEditFilter.class, intent15);
        com.prismaqf.callblocker.NewEditFilter neweditfilter7 = (com.prismaqf.callblocker.NewEditFilter) activitycontroller42.get();
        ...
        shadowactivity3.clickMenuItem(2131230742);
    }
}
