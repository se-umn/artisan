...
public class Test1761 {
     ...
     * Method invocation under test: <com.prismaqf.callblocker.sql.DbHelper: android.database.sqlite.SQLiteDatabase getReadableDatabase()>_148_294
     */
    @Test(timeout = 4000)
    public void test_com_prismaqf_callblocker_sql_DbHelper_getReadableDatabase_001() throws Exception {
        ...
        dbhelper3 = new com.prismaqf.callblocker.sql.DbHelper(context15);
