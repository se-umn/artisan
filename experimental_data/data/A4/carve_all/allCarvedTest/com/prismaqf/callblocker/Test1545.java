...
public class Test1545 {
     ...
     * Method invocation under test: <com.prismaqf.callblocker.EditFilterPatterns: void onCreate(android.os.Bundle)>_249_498
     */
    @Test(timeout = 4000)
    public void test_com_prismaqf_callblocker_EditFilterPatterns_onCreate_001() throws Exception {
        ...
        android.content.Intent intent5 = intent4.putExtra("com.prismaqft.callblocker:ptrule", (android.os.Parcelable) filterrule13);
        android.content.Intent intent6 = intent5.putExtra("com.prismaqft.callblocker:keyorig", (android.os.Parcelable) filterrule13);
