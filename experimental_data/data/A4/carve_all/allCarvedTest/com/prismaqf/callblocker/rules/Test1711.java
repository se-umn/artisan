...
public class Test1711 {
     ...
     * Method invocation under test: <com.prismaqf.callblocker.rules.FilterRule: void writeToParcel(android.os.Parcel,int)>_352_704
     */
    @Test(timeout = 4000)
    public void test_com_prismaqf_callblocker_rules_FilterRule_writeToParcel_003() throws Exception {
        java.lang.Object object29 = null;
        com.prismaqf.callblocker.rules.FilterRule filterrule55 = null;
        ...
        parcel76.writeString("my dummy rule");
        ...
        parcel79.writeString("my dummy rule");
        ...
        parcel83.writeString("my dummy rule");
        ...
        parcel85.writeInt(0);
        filterrule55 = new com.prismaqf.callblocker.rules.FilterRule("dummy", "change me");
        filterrule55.getPatternKeys();
        filterrule55.getPatternKeys();
        filterrule55.getName();
        filterrule55.setName("dummy");
        filterrule55.getDescription();
        filterrule55.setDescription("change me");
        filterrule55.equals(object29);
        filterrule55.getPatternKeys();
        filterrule55.getPatternKeys();
        filterrule55.equals(object29);
        filterrule55.setName("my dummy rule");
        filterrule55.writeToParcel(parcel81, 0);
        filterrule55.writeToParcel(parcel81, 0);
        filterrule55.writeToParcel(parcel85, 0);
    }
}
