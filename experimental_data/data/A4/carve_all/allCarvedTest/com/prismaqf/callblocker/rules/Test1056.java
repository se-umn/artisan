...
public class Test1056 {
    ...
    public void test_com_prismaqf_callblocker_rules_FilterRule_writeToParcel_005() throws Exception {
        ...
        android.os.Parcel parcel289 = stubber322.when(parcel285);
        parcel289.writeString("dummy");
        org.mockito.stubbing.Stubber stubber323 = org.mockito.Mockito.doNothing();
        android.os.Parcel parcel290 = stubber323.when(parcel285);
        parcel290.writeString("change me");
        org.mockito.stubbing.Stubber stubber324 = org.mockito.Mockito.doNothing();
        android.os.Parcel parcel291 = stubber324.when(parcel285);
        parcel291.writeInt(0);
        android.os.Parcel parcel292 = org.mockito.Mockito.mock(android.os.Parcel.class);
        org.mockito.stubbing.Stubber stubber325 = org.mockito.Mockito.doNothing();
        android.os.Parcel parcel293 = stubber325.when(parcel292);
        parcel293.writeString("dummy");
        org.mockito.stubbing.Stubber stubber326 = org.mockito.Mockito.doNothing();
        android.os.Parcel parcel294 = stubber326.when(parcel292);
        parcel294.writeString("change me");
        org.mockito.stubbing.Stubber stubber327 = org.mockito.Mockito.doNothing();
        android.os.Parcel parcel295 = stubber327.when(parcel292);
        ...
        filterrule93.writeToParcel(parcel291, 0);
        filterrule93.writeToParcel(parcel291, 0);
    }
}
