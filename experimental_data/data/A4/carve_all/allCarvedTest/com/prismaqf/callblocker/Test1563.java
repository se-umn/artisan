...
public class Test1563 {
    ...
    public void test_com_prismaqf_callblocker_NewEditFilter_onCreateOptionsMenu_001() throws Exception {
        ...
        org.mockito.stubbing.Stubber stubber19 = org.mockito.Mockito.doReturn("My filter with existing rules");
        ...
        filterhandle22.setName("My filter with existing rules");
        org.mockito.stubbing.Stubber stubber21 = org.mockito.Mockito.doReturn("My calendar rule for testing");
        ...
        org.mockito.stubbing.Stubber stubber22 = org.mockito.Mockito.doReturn("My filter rule for testing");
        ...
        android.content.Intent intent7 = intent6.putExtra("com.prismaqft.callblocker:ruleid", 2L);
        filterhandle25.writeToParcel(parcel9, 0);
        org.robolectric.android.controller.ActivityController activitycontroller33 = org.robolectric.Robolectric.buildActivity(com.prismaqf.callblocker.NewEditFilter.class, intent7);
        activitycontroller33.get();
        org.robolectric.android.controller.ActivityController activitycontroller34 = activitycontroller33.create();
        activitycontroller34.visible();
    }
}
