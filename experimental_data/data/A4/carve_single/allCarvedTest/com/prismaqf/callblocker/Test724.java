...
public class Test724 {
    ...
    public void test_com_prismaqf_callblocker_EditFilterPatterns_onCreate_001() throws Exception {
        ...
        android.content.Intent intent5 = intent4.putExtra("com.prismaqft.callblocker:ptrule", (android.os.Parcelable) filterrule8);
        android.content.Intent intent6 = intent5.putExtra("com.prismaqft.callblocker:keyorig", (android.os.Parcelable) filterrule8);
