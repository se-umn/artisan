...
public class Test476 {
    ...
    public void test_com_prismaqf_callblocker_NewEditFilter_onOptionsItemSelected_001() throws Exception {
        ...
        org.mockito.stubbing.Stubber stubber41 = org.mockito.Mockito.doReturn("My filter with existing rules");
        ...
        filterhandle41.setName("My filter with existing rules");
        org.mockito.stubbing.Stubber stubber43 = org.mockito.Mockito.doReturn("My calendar rule for testing");
        ...
        org.mockito.stubbing.Stubber stubber44 = org.mockito.Mockito.doReturn("My filter rule for testing");
        ...
        android.content.Intent intent11 = intent10.putExtra("com.prismaqft.callblocker:ruleid", 2L);
        filterhandle44.writeToParcel(parcel19, 0);
        org.robolectric.android.controller.ActivityController activitycontroller37 = org.robolectric.Robolectric.buildActivity(com.prismaqf.callblocker.NewEditFilter.class, intent11);
        com.prismaqf.callblocker.NewEditFilter neweditfilter5 = (com.prismaqf.callblocker.NewEditFilter) activitycontroller37.get();
