...
public class Test3815 {
    ...
    public void test_fifthelement_theelement_objects_Song_setAlbum_002() throws Exception {
        ...
        author180 = new fifthelement.theelement.objects.Author(uuid2021, "");
        java.util.UUID uuid2022 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album70 = new fifthelement.theelement.objects.Album(uuid2022, "");
        song35 = new fifthelement.theelement.objects.Song(uuid2020, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author180, album70, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song35.getAuthor();
        ...
        author179 = new fifthelement.theelement.objects.Author(uuid2025, "Coldplay", 10);
        song35.setAuthor(author179);
        song35.getAlbum();
        ...
        author178 = new fifthelement.theelement.objects.Author(uuid2028, "");
        album69 = new fifthelement.theelement.objects.Album(uuid2027, "A Head Full of Dreams", author178, list9, 10);
        album69.getAuthor();
        fifthelement.theelement.objects.Author author185 = album69.getAuthor();
        author185.getUUID();
        java.util.UUID uuid2030 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author181 = new fifthelement.theelement.objects.Author(uuid2030, "Coldplay", 10);
        album69.setAuthor(author181);
        song35.setAlbum(album69);
    }
}
