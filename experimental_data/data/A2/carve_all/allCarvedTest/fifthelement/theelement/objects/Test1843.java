...
public class Test1843 {
    ...
    public void test_fifthelement_theelement_objects_Song_setAuthor_004() throws Exception {
        ...
        author139 = new fifthelement.theelement.objects.Author(uuid1407, "");
        ...
        song32 = new fifthelement.theelement.objects.Song(uuid1406, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author139, album53, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song32.getAuthor();
        ...
        author140 = new fifthelement.theelement.objects.Author(uuid1411, "Coldplay", 10);
        song32.setAuthor(author140);
    }
}
