...
public class Test8010 {
    ...
    public void test_fifthelement_theelement_objects_Song_getUUID_010() throws Exception {
        ...
        author5083 = new fifthelement.theelement.objects.Author(uuid75200, "");
        java.util.UUID uuid75201 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album2169 = new fifthelement.theelement.objects.Album(uuid75201, "");
        song3896 = new fifthelement.theelement.objects.Song(uuid75199, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author5083, album2169, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song3896.getAuthor();
        ...
        author5085 = new fifthelement.theelement.objects.Author(uuid75204, "Coldplay", 10);
        song3896.setAuthor(author5085);
        song3896.getAlbum();
        ...
        author5086 = new fifthelement.theelement.objects.Author(uuid75207, "");
        album2170 = new fifthelement.theelement.objects.Album(uuid75206, "A Head Full of Dreams", author5086, list131, 10);
        album2170.getAuthor();
        fifthelement.theelement.objects.Author author5090 = album2170.getAuthor();
        author5090.getUUID();
        java.util.UUID uuid75209 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author5084 = new fifthelement.theelement.objects.Author(uuid75209, "Coldplay", 10);
        album2170.setAuthor(author5084);
        song3896.setAlbum(album2170);
        song3896.getUUID();
    }
}
