...
public class Test9204 {
    ...
    public void test_fifthelement_theelement_objects_Song_getName_003() throws Exception {
        ...
        author359 = new fifthelement.theelement.objects.Author(uuid4939, "");
        song78 = new fifthelement.theelement.objects.Song(uuid4938, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author359, album138, "Hiphop", 3, 1.5);
        ...
        author360 = new fifthelement.theelement.objects.Author(uuid4947, "Childish Gambino", 3);
        song78.setAuthor(author360);
        song78.getAlbum();
        song79.getAuthor();
        song79.getAlbum();
        song80.getAuthor();
