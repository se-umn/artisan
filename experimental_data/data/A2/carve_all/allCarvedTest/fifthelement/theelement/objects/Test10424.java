...
public class Test10424 {
    ...
    public void test_fifthelement_theelement_objects_Song_getName_001() throws Exception {
        ...
        author327 = new fifthelement.theelement.objects.Author(uuid4646, "");
        song68 = new fifthelement.theelement.objects.Song(uuid4645, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author327, album121, "Hiphop", 3, 1.5);
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        ...
        author326 = new fifthelement.theelement.objects.Author(uuid4654, "Childish Gambino", 3);
        song68.setAuthor(author326);
        song68.getAlbum();
        song68.getName();
    }
}
