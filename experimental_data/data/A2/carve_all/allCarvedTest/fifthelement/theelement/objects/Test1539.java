...
public class Test1539 {
    ...
    public void test_fifthelement_theelement_objects_Song_getAlbum_010() throws Exception {
        ...
        author147 = new fifthelement.theelement.objects.Author(uuid1497, "");
        ...
        song34 = new fifthelement.theelement.objects.Song(uuid1496, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author147, album56, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song34.getAuthor();
        ...
        author148 = new fifthelement.theelement.objects.Author(uuid1501, "Coldplay", 10);
        song34.setAuthor(author148);
        song34.getAlbum();
        song34.getAlbum();
    }
}
