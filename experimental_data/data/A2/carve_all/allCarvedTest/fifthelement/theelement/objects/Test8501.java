...
public class Test8501 {
    ...
    public void test_fifthelement_theelement_objects_Song_setAlbum_003() throws Exception {
        ...
        author309 = new fifthelement.theelement.objects.Author(uuid4466, "");
        java.util.UUID uuid4467 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album112 = new fifthelement.theelement.objects.Album(uuid4467, "");
        song57 = new fifthelement.theelement.objects.Song(uuid4465, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author309, album112, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song57.getAuthor();
        ...
        author308 = new fifthelement.theelement.objects.Author(uuid4470, "Coldplay", 10);
        song57.setAuthor(author308);
        song57.getAlbum();
        ...
        author310 = new fifthelement.theelement.objects.Author(uuid4473, "");
        album111 = new fifthelement.theelement.objects.Album(uuid4472, "A Head Full of Dreams", author310, list14, 10);
        album111.getAuthor();
        fifthelement.theelement.objects.Author author315 = album111.getAuthor();
        author315.getUUID();
        java.util.UUID uuid4475 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author311 = new fifthelement.theelement.objects.Author(uuid4475, "Coldplay", 10);
        album111.setAuthor(author311);
