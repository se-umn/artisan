...
public class Test9616 {
     ...
     * Method invocation under test: <fifthelement.theelement.objects.Song: fifthelement.theelement.objects.Album getAlbum()>_499_994
     */
    @Test(timeout = 4000)
    public void test_fifthelement_theelement_objects_Song_getAlbum_014() throws Exception {
        ...
        author266 = new fifthelement.theelement.objects.Author(uuid3595, "");
        ...
        song55 = new fifthelement.theelement.objects.Song(uuid3594, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author266, album94, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song55.getAuthor();
        ...
        author265 = new fifthelement.theelement.objects.Author(uuid3599, "Coldplay", 10);
