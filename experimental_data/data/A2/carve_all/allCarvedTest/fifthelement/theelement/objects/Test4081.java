...
public class Test4081 {
     ...
     * Method invocation under test: <fifthelement.theelement.objects.Author: void <init>(java.util.UUID,java.lang.String,int)>_1175_2344
     */
    @Test(timeout = 4000)
    public void test_fifthelement_theelement_objects_Author_constructor_039() throws Exception {
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        java.util.UUID uuid25838 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author3899 = new fifthelement.theelement.objects.Author(uuid25838, "Coldplay", 10);
    }
}
