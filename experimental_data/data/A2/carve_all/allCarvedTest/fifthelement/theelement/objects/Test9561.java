...
public class Test9561 {
    ...
    public void test_fifthelement_theelement_objects_Song_getAlbum_009() throws Exception {
        ...
        author144 = new fifthelement.theelement.objects.Author(uuid1452, "");
        ...
        song33 = new fifthelement.theelement.objects.Song(uuid1451, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author144, album54, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song33.getAuthor();
        ...
        author143 = new fifthelement.theelement.objects.Author(uuid1456, "Coldplay", 10);
        song33.setAuthor(author143);
        song33.getAlbum();
    }
}
