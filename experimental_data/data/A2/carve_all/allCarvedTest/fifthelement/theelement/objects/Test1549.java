...
public class Test1549 {
    ...
    public void test_fifthelement_theelement_objects_Album_setAuthor_002() throws Exception {
        ...
        author175 = new fifthelement.theelement.objects.Author(uuid1975, "");
        album68 = new fifthelement.theelement.objects.Album(uuid1974, "A Head Full of Dreams", author175, list8, 10);
        album68.getAuthor();
        ...
        author174 = new fifthelement.theelement.objects.Author(uuid1977, "Coldplay", 10);
        album68.setAuthor(author174);
    }
}
