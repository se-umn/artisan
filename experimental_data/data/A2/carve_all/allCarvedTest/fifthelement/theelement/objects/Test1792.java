...
public class Test1792 {
    ...
    public void test_fifthelement_theelement_objects_Song_getAlbum_001() throws Exception {
        ...
        author20 = new fifthelement.theelement.objects.Author(uuid126, "");
        song7 = new fifthelement.theelement.objects.Song(uuid125, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author20, album8, "Hiphop", 3, 1.5);
        ...
        author21 = new fifthelement.theelement.objects.Author(uuid134, "Childish Gambino", 3);
        song7.setAuthor(author21);
        song7.getAlbum();
    }
}
