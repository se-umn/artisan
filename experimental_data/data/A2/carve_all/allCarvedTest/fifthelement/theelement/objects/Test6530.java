...
public class Test6530 {
    ...
    public void test_fifthelement_theelement_objects_Song_setAlbum_003() throws Exception {
        ...
        author307 = new fifthelement.theelement.objects.Author(uuid4465, "");
        java.util.UUID uuid4466 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album112 = new fifthelement.theelement.objects.Album(uuid4466, "");
        song57 = new fifthelement.theelement.objects.Song(uuid4464, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author307, album112, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song57.getAuthor();
        ...
        author310 = new fifthelement.theelement.objects.Author(uuid4469, "Coldplay", 10);
        song57.setAuthor(author310);
        song57.getAlbum();
        ...
        album111 = new fifthelement.theelement.objects.Album(uuid4471, "A Head Full of Dreams", author309, list14, 10);
        album111.getAuthor();
        fifthelement.theelement.objects.Author author314 = album111.getAuthor();
        author314.getUUID();
        java.util.UUID uuid4474 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author308 = new fifthelement.theelement.objects.Author(uuid4474, "Coldplay", 10);
