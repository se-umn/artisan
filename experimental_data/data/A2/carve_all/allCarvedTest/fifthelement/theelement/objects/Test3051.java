...
public class Test3051 {
     ...
     * Method invocation under test: <fifthelement.theelement.objects.Song: fifthelement.theelement.objects.Album getAlbum()>_500_996
     */
    @Test(timeout = 4000)
    public void test_fifthelement_theelement_objects_Song_getAlbum_015() throws Exception {
        ...
        author270 = new fifthelement.theelement.objects.Author(uuid3666, "");
        ...
        song56 = new fifthelement.theelement.objects.Song(uuid3665, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author270, album96, "Pop", 10, 3.5);
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        song56.getAuthor();
        ...
        author269 = new fifthelement.theelement.objects.Author(uuid3670, "Coldplay", 10);
