...
public class Test5700 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_sortSongs_002() throws Exception {
        ...
        song235 = new fifthelement.theelement.objects.Song(uuid48127, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1681, album544, "Hiphop", 3, 1.5);
        arraylist415.add(song235);
        java.util.UUID uuid48129 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song236 = new fifthelement.theelement.objects.Song(uuid48129, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1685, album544, "", 3, 4.5);
        arraylist415.add(song236);
        java.util.UUID uuid48130 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song242 = new fifthelement.theelement.objects.Song(uuid48130, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1685, album544, "Classical", 4, 2.0);
        arraylist415.add(song242);
        ...
        album542 = new fifthelement.theelement.objects.Album(uuid48133, "");
        song234 = new fifthelement.theelement.objects.Song(uuid48131, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1679, album542, "Pop", 10, 3.5);
        ...
        author1683 = new fifthelement.theelement.objects.Author(uuid48199, "");
        song239 = new fifthelement.theelement.objects.Song(uuid48198, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1683, album544, "Hiphop", 3, 1.5);
        arraylist416.add(song239);
        java.util.UUID uuid48200 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song238 = new fifthelement.theelement.objects.Song(uuid48200, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1685, album544, "", 3, 4.5);
        arraylist416.add(song238);
        java.util.UUID uuid48201 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song233 = new fifthelement.theelement.objects.Song(uuid48201, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1685, album544, "Classical", 4, 2.0);
        ...
        album546 = new fifthelement.theelement.objects.Album(uuid48204, "");
        song237 = new fifthelement.theelement.objects.Song(uuid48202, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1678, album546, "Pop", 10, 3.5);
        arraylist416.add(song237);
        arraylist416.iterator();
        song239.getAuthor();
        fifthelement.theelement.objects.Author author1690 = song239.getAuthor();
        author1690.getUUID();
        ...
        song239.setAuthor(author1684);
        song239.getAlbum();
        song238.getAuthor();
        song238.getAlbum();
        fifthelement.theelement.objects.Author author1692 = song233.getAuthor();
        fifthelement.theelement.objects.Album album549 = song233.getAlbum();
        song237.getAuthor();
        ...
        author1680 = new fifthelement.theelement.objects.Author(uuid48208, "Coldplay", 10);
        song237.setAuthor(author1680);
        song237.getAlbum();
        ...
        author1688 = new fifthelement.theelement.objects.Author(uuid48211, "");
        album545 = new fifthelement.theelement.objects.Album(uuid48210, "A Head Full of Dreams", author1688, list78, 10);
        album545.getAuthor();
        fifthelement.theelement.objects.Author author1696 = album545.getAuthor();
        author1696.getUUID();
        java.util.UUID uuid48213 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1687 = new fifthelement.theelement.objects.Author(uuid48213, "Coldplay", 10);
        album545.setAuthor(author1687);
        song237.setAlbum(album545);
        ...
        author1686 = new fifthelement.theelement.objects.Author(uuid48228, "");
        song241 = new fifthelement.theelement.objects.Song(uuid48227, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1686, album549, "Hiphop", 3, 1.5);
        arraylist414.add(song241);
        java.util.UUID uuid48229 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song243 = new fifthelement.theelement.objects.Song(uuid48229, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1692, album549, "", 3, 4.5);
        arraylist414.add(song243);
        java.util.UUID uuid48230 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song232 = new fifthelement.theelement.objects.Song(uuid48230, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1692, album549, "Classical", 4, 2.0);
        ...
        author1682 = new fifthelement.theelement.objects.Author(uuid48232, "");
        java.util.UUID uuid48233 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album543 = new fifthelement.theelement.objects.Album(uuid48233, "");
        song240 = new fifthelement.theelement.objects.Song(uuid48231, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1682, album543, "Pop", 10, 3.5);
