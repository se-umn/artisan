...
public class Test7800 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_getAutoplayEnabled_001() throws Exception {
        ...
        song175 = new fifthelement.theelement.objects.Song(uuid30950, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1171, album421, "Hiphop", 3, 1.5);
        arraylist274.add(song175);
        java.util.UUID uuid30952 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song176 = new fifthelement.theelement.objects.Song(uuid30952, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1176, album421, "", 3, 4.5);
        arraylist274.add(song176);
        java.util.UUID uuid30953 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song178 = new fifthelement.theelement.objects.Song(uuid30953, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1176, album421, "Classical", 4, 2.0);
        ...
        album419 = new fifthelement.theelement.objects.Album(uuid30956, "");
        song173 = new fifthelement.theelement.objects.Song(uuid30954, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1170, album419, "Pop", 10, 3.5);
        ...
        author1169 = new fifthelement.theelement.objects.Author(uuid31022, "");
        song174 = new fifthelement.theelement.objects.Song(uuid31021, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1169, album421, "Hiphop", 3, 1.5);
        arraylist273.add(song174);
        java.util.UUID uuid31023 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song172 = new fifthelement.theelement.objects.Song(uuid31023, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1176, album421, "", 3, 4.5);
        arraylist273.add(song172);
        java.util.UUID uuid31024 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song177 = new fifthelement.theelement.objects.Song(uuid31024, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1176, album421, "Classical", 4, 2.0);
        ...
        song179 = new fifthelement.theelement.objects.Song(uuid31025, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1168, album420, "Pop", 10, 3.5);
        arraylist273.add(song179);
        arraylist273.iterator();
        song174.getAuthor();
        fifthelement.theelement.objects.Author author1178 = song174.getAuthor();
        author1178.getUUID();
        ...
        song177.getAlbum();
        song179.getAuthor();
        fifthelement.theelement.objects.Author author1182 = song179.getAuthor();
        author1182.getUUID();
        java.util.UUID uuid31031 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1175 = new fifthelement.theelement.objects.Author(uuid31031, "Coldplay", 10);
        song179.setAuthor(author1175);
        song179.getAlbum();
        fifthelement.theelement.objects.Album album426 = song179.getAlbum();
        album426.getUUID();
        ...
        author1174 = new fifthelement.theelement.objects.Author(uuid31034, "");
        album418 = new fifthelement.theelement.objects.Album(uuid31033, "A Head Full of Dreams", author1174, list66, 10);
        album418.getAuthor();
        fifthelement.theelement.objects.Author author1184 = album418.getAuthor();
        author1184.getUUID();
        ...
        album418.setAuthor(author1172);
        song179.setAlbum(album418);
