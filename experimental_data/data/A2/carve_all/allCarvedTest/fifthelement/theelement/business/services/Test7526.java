...
public class Test7526 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_setCurrentSongsList_001() throws Exception {
        ...
        song39 = new fifthelement.theelement.objects.Song(uuid2038, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author188, album74, "Hiphop", 3, 1.5);
        arraylist12.add(song39);
        java.util.UUID uuid2040 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song36 = new fifthelement.theelement.objects.Song(uuid2040, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author187, album74, "", 3, 4.5);
        arraylist12.add(song36);
        java.util.UUID uuid2041 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song37 = new fifthelement.theelement.objects.Song(uuid2041, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author187, album74, "Classical", 4, 2.0);
        ...
        author186 = new fifthelement.theelement.objects.Author(uuid2043, "");
        java.util.UUID uuid2044 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album73 = new fifthelement.theelement.objects.Album(uuid2044, "");
        song38 = new fifthelement.theelement.objects.Song(uuid2042, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author186, album73, "Pop", 10, 3.5);
