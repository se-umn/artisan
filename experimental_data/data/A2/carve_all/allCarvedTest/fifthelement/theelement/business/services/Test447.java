...
public class Test447 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_sortSongs_002() throws Exception {
        ...
        author1679 = new fifthelement.theelement.objects.Author(uuid48128, "");
        song240 = new fifthelement.theelement.objects.Song(uuid48127, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1679, album546, "Hiphop", 3, 1.5);
        arraylist416.add(song240);
        java.util.UUID uuid48129 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song242 = new fifthelement.theelement.objects.Song(uuid48129, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1684, album546, "", 3, 4.5);
        arraylist416.add(song242);
        java.util.UUID uuid48130 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song235 = new fifthelement.theelement.objects.Song(uuid48130, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1684, album546, "Classical", 4, 2.0);
        arraylist416.add(song235);
        ...
        author1678 = new fifthelement.theelement.objects.Author(uuid48132, "");
        java.util.UUID uuid48133 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album545 = new fifthelement.theelement.objects.Album(uuid48133, "");
        song243 = new fifthelement.theelement.objects.Song(uuid48131, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1678, album545, "Pop", 10, 3.5);
        ...
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        songlistservice4.setCurrentSongsList(arraylist416);
        ...
        author1681 = new fifthelement.theelement.objects.Author(uuid48199, "");
        song233 = new fifthelement.theelement.objects.Song(uuid48198, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1681, album546, "Hiphop", 3, 1.5);
        arraylist415.add(song233);
        java.util.UUID uuid48200 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song234 = new fifthelement.theelement.objects.Song(uuid48200, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1684, album546, "", 3, 4.5);
        arraylist415.add(song234);
        java.util.UUID uuid48201 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song236 = new fifthelement.theelement.objects.Song(uuid48201, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1684, album546, "Classical", 4, 2.0);
        ...
        author1687 = new fifthelement.theelement.objects.Author(uuid48203, "");
        java.util.UUID uuid48204 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album542 = new fifthelement.theelement.objects.Album(uuid48204, "");
        song237 = new fifthelement.theelement.objects.Song(uuid48202, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1687, album542, "Pop", 10, 3.5);
        arraylist415.add(song237);
        arraylist415.iterator();
        song233.getAuthor();
        fifthelement.theelement.objects.Author author1690 = song233.getAuthor();
        author1690.getUUID();
        ...
        song237.getAuthor();
        fifthelement.theelement.objects.Author author1694 = song237.getAuthor();
        author1694.getUUID();
        java.util.UUID uuid48208 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1688 = new fifthelement.theelement.objects.Author(uuid48208, "Coldplay", 10);
        song237.setAuthor(author1688);
        song237.getAlbum();
        fifthelement.theelement.objects.Album album551 = song237.getAlbum();
        album551.getUUID();
        ...
        album543 = new fifthelement.theelement.objects.Album(uuid48210, "A Head Full of Dreams", author1685, list78, 10);
        album543.getAuthor();
        fifthelement.theelement.objects.Author author1696 = album543.getAuthor();
        author1696.getUUID();
        ...
        album543.setAuthor(author1683);
        song237.setAlbum(album543);
        ...
        song232 = new fifthelement.theelement.objects.Song(uuid48227, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1682, album549, "Hiphop", 3, 1.5);
        arraylist414.add(song232);
        java.util.UUID uuid48229 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song241 = new fifthelement.theelement.objects.Song(uuid48229, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1692, album549, "", 3, 4.5);
        arraylist414.add(song241);
        java.util.UUID uuid48230 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song238 = new fifthelement.theelement.objects.Song(uuid48230, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1692, album549, "Classical", 4, 2.0);
        arraylist414.add(song238);
        ...
        author1680 = new fifthelement.theelement.objects.Author(uuid48232, "");
        ...
        song239 = new fifthelement.theelement.objects.Song(uuid48231, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1680, album544, "Pop", 10, 3.5);
