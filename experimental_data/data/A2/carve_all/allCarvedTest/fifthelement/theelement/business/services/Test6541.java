...
public class Test6541 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_getAutoplayEnabled_001() throws Exception {
        ...
        author391 = new fifthelement.theelement.objects.Author(uuid5185, "");
        song95 = new fifthelement.theelement.objects.Song(uuid5184, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author391, album155, "Hiphop", 3, 1.5);
        arraylist30.add(song95);
        java.util.UUID uuid5186 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song99 = new fifthelement.theelement.objects.Song(uuid5186, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author390, album155, "", 3, 4.5);
        arraylist30.add(song99);
        java.util.UUID uuid5187 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song98 = new fifthelement.theelement.objects.Song(uuid5187, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author390, album155, "Classical", 4, 2.0);
        ...
        author394 = new fifthelement.theelement.objects.Author(uuid5197, "");
        song93 = new fifthelement.theelement.objects.Song(uuid5196, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author394, album155, "Hiphop", 3, 1.5);
        arraylist31.add(song93);
        java.util.UUID uuid5198 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song94 = new fifthelement.theelement.objects.Song(uuid5198, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author390, album155, "", 3, 4.5);
        arraylist31.add(song94);
        java.util.UUID uuid5199 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song96 = new fifthelement.theelement.objects.Song(uuid5199, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author390, album155, "Classical", 4, 2.0);
        arraylist31.add(song96);
        ...
        author392 = new fifthelement.theelement.objects.Author(uuid5201, "");
        java.util.UUID uuid5202 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album157 = new fifthelement.theelement.objects.Album(uuid5202, "");
        song97 = new fifthelement.theelement.objects.Song(uuid5200, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author392, album157, "Pop", 10, 3.5);
        arraylist31.add(song97);
        ...
        author393 = new fifthelement.theelement.objects.Author(uuid5204, "Childish Gambino", 3);
        song93.setAuthor(author393);
        song93.getAlbum();
        song94.getAuthor();
        song94.getAlbum();
        song96.getAuthor();
        song96.getAlbum();
        song97.getAuthor();
        fifthelement.theelement.objects.Author author400 = song97.getAuthor();
        author400.getUUID();
        java.util.UUID uuid5206 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author389 = new fifthelement.theelement.objects.Author(uuid5206, "Coldplay", 10);
        song97.setAuthor(author389);
        song97.getAlbum();
        fifthelement.theelement.objects.Album album162 = song97.getAlbum();
        album162.getUUID();
        ...
        author387 = new fifthelement.theelement.objects.Author(uuid5209, "");
        album156 = new fifthelement.theelement.objects.Album(uuid5208, "A Head Full of Dreams", author387, list17, 10);
        album156.getAuthor();
        fifthelement.theelement.objects.Author author402 = album156.getAuthor();
        author402.getUUID();
        java.util.UUID uuid5211 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author386 = new fifthelement.theelement.objects.Author(uuid5211, "Coldplay", 10);
        album156.setAuthor(author386);
        song97.setAlbum(album156);
