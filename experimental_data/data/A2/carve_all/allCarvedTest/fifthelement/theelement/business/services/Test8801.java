...
public class Test8801 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_sortSongs_002() throws Exception {
        ...
        author1680 = new fifthelement.theelement.objects.Author(uuid48128, "");
        song239 = new fifthelement.theelement.objects.Song(uuid48127, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1680, album545, "Hiphop", 3, 1.5);
        arraylist414.add(song239);
        java.util.UUID uuid48129 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song240 = new fifthelement.theelement.objects.Song(uuid48129, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1685, album545, "", 3, 4.5);
        arraylist414.add(song240);
        java.util.UUID uuid48130 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song234 = new fifthelement.theelement.objects.Song(uuid48130, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1685, album545, "Classical", 4, 2.0);
        arraylist414.add(song234);
        ...
        author1679 = new fifthelement.theelement.objects.Author(uuid48132, "");
        ...
        song242 = new fifthelement.theelement.objects.Song(uuid48131, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1679, album543, "Pop", 10, 3.5);
        ...
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        songlistservice4.setCurrentSongsList(arraylist414);
        ...
        author1682 = new fifthelement.theelement.objects.Author(uuid48199, "");
        song235 = new fifthelement.theelement.objects.Song(uuid48198, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1682, album545, "Hiphop", 3, 1.5);
        arraylist415.add(song235);
        java.util.UUID uuid48200 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song233 = new fifthelement.theelement.objects.Song(uuid48200, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1685, album545, "", 3, 4.5);
        arraylist415.add(song233);
        java.util.UUID uuid48201 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song236 = new fifthelement.theelement.objects.Song(uuid48201, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1685, album545, "Classical", 4, 2.0);
        arraylist415.add(song236);
        ...
        author1683 = new fifthelement.theelement.objects.Author(uuid48203, "");
        java.util.UUID uuid48204 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album544 = new fifthelement.theelement.objects.Album(uuid48204, "");
        song241 = new fifthelement.theelement.objects.Song(uuid48202, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1683, album544, "Pop", 10, 3.5);
        arraylist415.add(song241);
        arraylist415.iterator();
        song235.getAuthor();
        fifthelement.theelement.objects.Author author1690 = song235.getAuthor();
        author1690.getUUID();
        java.util.UUID uuid48206 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author1686 = new fifthelement.theelement.objects.Author(uuid48206, "Childish Gambino", 3);
        song235.setAuthor(author1686);
        song235.getAlbum();
        song233.getAuthor();
        song233.getAlbum();
        fifthelement.theelement.objects.Author author1692 = song236.getAuthor();
        fifthelement.theelement.objects.Album album549 = song236.getAlbum();
        song241.getAuthor();
        fifthelement.theelement.objects.Author author1694 = song241.getAuthor();
        author1694.getUUID();
        ...
        song241.setAuthor(author1687);
        song241.getAlbum();
        fifthelement.theelement.objects.Album album551 = song241.getAlbum();
        album551.getUUID();
        ...
        author1678 = new fifthelement.theelement.objects.Author(uuid48211, "");
        album546 = new fifthelement.theelement.objects.Album(uuid48210, "A Head Full of Dreams", author1678, list78, 10);
        album546.getAuthor();
        fifthelement.theelement.objects.Author author1696 = album546.getAuthor();
        author1696.getUUID();
        java.util.UUID uuid48213 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1688 = new fifthelement.theelement.objects.Author(uuid48213, "Coldplay", 10);
        album546.setAuthor(author1688);
        song241.setAlbum(album546);
        songlistservice4.sortSongs(arraylist415);
        arraylist415.size();
        arraylist415.size();
        ...
        author1681 = new fifthelement.theelement.objects.Author(uuid48228, "");
        song243 = new fifthelement.theelement.objects.Song(uuid48227, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1681, album549, "Hiphop", 3, 1.5);
        arraylist416.add(song243);
        java.util.UUID uuid48229 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song232 = new fifthelement.theelement.objects.Song(uuid48229, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1692, album549, "", 3, 4.5);
        arraylist416.add(song232);
        java.util.UUID uuid48230 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song237 = new fifthelement.theelement.objects.Song(uuid48230, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1692, album549, "Classical", 4, 2.0);
        ...
        author1684 = new fifthelement.theelement.objects.Author(uuid48232, "");
        java.util.UUID uuid48233 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album542 = new fifthelement.theelement.objects.Album(uuid48233, "");
        song238 = new fifthelement.theelement.objects.Song(uuid48231, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1684, album542, "Pop", 10, 3.5);
        arraylist416.add(song238);
