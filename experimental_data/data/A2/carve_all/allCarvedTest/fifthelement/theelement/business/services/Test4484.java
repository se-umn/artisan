...
public class Test4484 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_getAutoplayEnabled_001() throws Exception {
        ...
        author1169 = new fifthelement.theelement.objects.Author(uuid30951, "");
        song177 = new fifthelement.theelement.objects.Song(uuid30950, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1169, album421, "Hiphop", 3, 1.5);
        arraylist274.add(song177);
        java.util.UUID uuid30952 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song178 = new fifthelement.theelement.objects.Song(uuid30952, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1172, album421, "", 3, 4.5);
        arraylist274.add(song178);
        java.util.UUID uuid30953 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song174 = new fifthelement.theelement.objects.Song(uuid30953, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1172, album421, "Classical", 4, 2.0);
        ...
        author1168 = new fifthelement.theelement.objects.Author(uuid30955, "");
        java.util.UUID uuid30956 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album420 = new fifthelement.theelement.objects.Album(uuid30956, "");
        song179 = new fifthelement.theelement.objects.Song(uuid30954, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1168, album420, "Pop", 10, 3.5);
        arraylist274.add(song179);
        ...
        author1170 = new fifthelement.theelement.objects.Author(uuid31022, "");
        song172 = new fifthelement.theelement.objects.Song(uuid31021, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1170, album421, "Hiphop", 3, 1.5);
        arraylist273.add(song172);
        java.util.UUID uuid31023 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song173 = new fifthelement.theelement.objects.Song(uuid31023, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1172, album421, "", 3, 4.5);
        arraylist273.add(song173);
        java.util.UUID uuid31024 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song175 = new fifthelement.theelement.objects.Song(uuid31024, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1172, album421, "Classical", 4, 2.0);
        ...
        author1175 = new fifthelement.theelement.objects.Author(uuid31026, "");
        java.util.UUID uuid31027 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album418 = new fifthelement.theelement.objects.Album(uuid31027, "");
        song176 = new fifthelement.theelement.objects.Song(uuid31025, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1175, album418, "Pop", 10, 3.5);
        arraylist273.add(song176);
        arraylist273.iterator();
        song172.getAuthor();
        fifthelement.theelement.objects.Author author1178 = song172.getAuthor();
        author1178.getUUID();
        java.util.UUID uuid31029 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author1174 = new fifthelement.theelement.objects.Author(uuid31029, "Childish Gambino", 3);
        song172.setAuthor(author1174);
        song172.getAlbum();
        song173.getAuthor();
        song173.getAlbum();
        song175.getAuthor();
        ...
        author1176 = new fifthelement.theelement.objects.Author(uuid31031, "Coldplay", 10);
        song176.setAuthor(author1176);
        song176.getAlbum();
        ...
        author1171 = new fifthelement.theelement.objects.Author(uuid31036, "Coldplay", 10);
        album419.setAuthor(author1171);
