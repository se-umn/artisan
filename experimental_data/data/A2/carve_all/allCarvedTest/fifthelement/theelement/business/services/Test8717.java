...
public class Test8717 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_getAutoplayEnabled_001() throws Exception {
        ...
        author1170 = new fifthelement.theelement.objects.Author(uuid30951, "");
        song176 = new fifthelement.theelement.objects.Song(uuid30950, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1170, album420, "Hiphop", 3, 1.5);
        arraylist273.add(song176);
        java.util.UUID uuid30952 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song177 = new fifthelement.theelement.objects.Song(uuid30952, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1173, album420, "", 3, 4.5);
        arraylist273.add(song177);
        java.util.UUID uuid30953 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song173 = new fifthelement.theelement.objects.Song(uuid30953, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1173, album420, "Classical", 4, 2.0);
        ...
        song179 = new fifthelement.theelement.objects.Song(uuid30954, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1169, album418, "Pop", 10, 3.5);
        ...
        author1171 = new fifthelement.theelement.objects.Author(uuid31022, "");
        song174 = new fifthelement.theelement.objects.Song(uuid31021, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1171, album420, "Hiphop", 3, 1.5);
        arraylist274.add(song174);
        java.util.UUID uuid31023 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song172 = new fifthelement.theelement.objects.Song(uuid31023, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1173, album420, "", 3, 4.5);
        arraylist274.add(song172);
        java.util.UUID uuid31024 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song175 = new fifthelement.theelement.objects.Song(uuid31024, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1173, album420, "Classical", 4, 2.0);
        ...
        author1172 = new fifthelement.theelement.objects.Author(uuid31026, "");
        java.util.UUID uuid31027 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album419 = new fifthelement.theelement.objects.Album(uuid31027, "");
        song178 = new fifthelement.theelement.objects.Song(uuid31025, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1172, album419, "Pop", 10, 3.5);
        ...
        song175.getAlbum();
        song178.getAuthor();
        fifthelement.theelement.objects.Author author1182 = song178.getAuthor();
        author1182.getUUID();
        ...
        song178.setAuthor(author1175);
        song178.getAlbum();
        fifthelement.theelement.objects.Album album426 = song178.getAlbum();
        album426.getUUID();
        ...
        author1168 = new fifthelement.theelement.objects.Author(uuid31034, "");
        album421 = new fifthelement.theelement.objects.Album(uuid31033, "A Head Full of Dreams", author1168, list66, 10);
        album421.getAuthor();
        fifthelement.theelement.objects.Author author1184 = album421.getAuthor();
        author1184.getUUID();
        java.util.UUID uuid31036 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1176 = new fifthelement.theelement.objects.Author(uuid31036, "Coldplay", 10);
        album421.setAuthor(author1176);
        song178.setAlbum(album421);
