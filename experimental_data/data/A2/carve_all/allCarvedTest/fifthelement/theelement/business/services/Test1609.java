...
public class Test1609 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_setCurrentSongsList_002() throws Exception {
        ...
        author316 = new fifthelement.theelement.objects.Author(uuid4493, "");
        song61 = new fifthelement.theelement.objects.Song(uuid4492, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author316, album117, "Hiphop", 3, 1.5);
        arraylist25.add(song61);
        java.util.UUID uuid4494 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song62 = new fifthelement.theelement.objects.Song(uuid4494, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author314, album117, "", 3, 4.5);
        arraylist25.add(song62);
        java.util.UUID uuid4495 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song63 = new fifthelement.theelement.objects.Song(uuid4495, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author314, album117, "Classical", 4, 2.0);
        ...
        song64 = new fifthelement.theelement.objects.Song(uuid4496, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author313, album115, "Pop", 10, 3.5);
        ...
        author317 = new fifthelement.theelement.objects.Author(uuid4505, "");
        song58 = new fifthelement.theelement.objects.Song(uuid4504, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author317, album117, "Hiphop", 3, 1.5);
        arraylist26.add(song58);
        java.util.UUID uuid4506 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song65 = new fifthelement.theelement.objects.Song(uuid4506, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author314, album117, "", 3, 4.5);
        arraylist26.add(song65);
        java.util.UUID uuid4507 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song60 = new fifthelement.theelement.objects.Song(uuid4507, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author314, album117, "Classical", 4, 2.0);
        ...
        author315 = new fifthelement.theelement.objects.Author(uuid4509, "");
        ...
        song59 = new fifthelement.theelement.objects.Song(uuid4508, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author315, album116, "Pop", 10, 3.5);
