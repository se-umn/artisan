...
public class Test7055 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_sortSongs_001() throws Exception {
        ...
        author317 = new fifthelement.theelement.objects.Author(uuid4495, "");
        song60 = new fifthelement.theelement.objects.Song(uuid4494, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author317, album117, "Hiphop", 3, 1.5);
        arraylist25.add(song60);
        java.util.UUID uuid4496 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song62 = new fifthelement.theelement.objects.Song(uuid4496, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author315, album117, "", 3, 4.5);
        arraylist25.add(song62);
        java.util.UUID uuid4497 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song61 = new fifthelement.theelement.objects.Song(uuid4497, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author315, album117, "Classical", 4, 2.0);
        ...
        author316 = new fifthelement.theelement.objects.Author(uuid4507, "");
        song58 = new fifthelement.theelement.objects.Song(uuid4506, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author316, album117, "Hiphop", 3, 1.5);
        arraylist26.add(song58);
        java.util.UUID uuid4508 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song59 = new fifthelement.theelement.objects.Song(uuid4508, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author315, album117, "", 3, 4.5);
        arraylist26.add(song59);
        java.util.UUID uuid4509 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song63 = new fifthelement.theelement.objects.Song(uuid4509, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author315, album117, "Classical", 4, 2.0);
        arraylist26.add(song63);
        ...
        author318 = new fifthelement.theelement.objects.Author(uuid4511, "");
        java.util.UUID uuid4512 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album116 = new fifthelement.theelement.objects.Album(uuid4512, "");
        song64 = new fifthelement.theelement.objects.Song(uuid4510, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author318, album116, "Pop", 10, 3.5);
