...
public class Test1746 {
     ...
     * Method invocation under test: <fifthelement.theelement.persistence.hsqldb.AuthorPersistenceHSQLDB: fifthelement.theelement.objects.Author getAuthorByUUID(java.util.UUID)>_579_1156
     */
    @Test(timeout = 4000)
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_008() throws Exception {
        ...
        fifthelement.theelement.objects.Author author243 = null;
        fifthelement.theelement.objects.Author author247 = null;
        ...
        author243 = new fifthelement.theelement.objects.Author(uuid3368, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid3375 = author243.getUUID();
        ...
        author247 = new fifthelement.theelement.objects.Author(uuid3377, "");
        java.util.UUID uuid3378 = author247.getUUID();
        ...
        authorpersistencehsqldb8.getAuthorByUUID(uuid3384);
    }
}
