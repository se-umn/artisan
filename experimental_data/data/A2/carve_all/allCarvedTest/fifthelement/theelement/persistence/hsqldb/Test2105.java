...
public class Test2105 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_017() throws Exception {
        ...
        fifthelement.theelement.objects.Author author991 = null;
        ...
        author990 = new fifthelement.theelement.objects.Author(uuid26140, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid26147 = author990.getUUID();
        ...
        author991 = new fifthelement.theelement.objects.Author(uuid26161, "");
        java.util.UUID uuid26162 = author991.getUUID();
        ...
        author976 = new fifthelement.theelement.objects.Author(uuid26172, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb21.getAuthorByUUID(uuid26168);
        java.util.UUID uuid26175 = author976.getUUID();
        ...
        author983 = new fifthelement.theelement.objects.Author(uuid26183, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid26187 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author978 = new fifthelement.theelement.objects.Author(uuid26187, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid26190 = author983.getUUID();
        authorpersistencehsqldb21.getAuthorByUUID(uuid26190);
        java.util.UUID uuid26191 = author978.getUUID();
        ...
        author979 = new fifthelement.theelement.objects.Author(uuid26204, "");
        authorpersistencehsqldb21.getAuthorByUUID(uuid26200);
        java.util.UUID uuid26205 = author979.getUUID();
