...
public class Test6775 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_016() throws Exception {
        ...
        fifthelement.theelement.objects.Author author6329 = null;
        fifthelement.theelement.objects.Author author6331 = null;
        fifthelement.theelement.objects.Author author6336 = null;
        fifthelement.theelement.objects.Author author6337 = null;
        fifthelement.theelement.objects.Author author6340 = null;
        ...
        author6336 = new fifthelement.theelement.objects.Author(uuid29511, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid29518 = author6336.getUUID();
        ...
        author6340 = new fifthelement.theelement.objects.Author(uuid29520, "");
        java.util.UUID uuid29521 = author6340.getUUID();
        ...
        author6337 = new fifthelement.theelement.objects.Author(uuid29527, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb16.getAuthorByUUID(uuid29523);
        java.util.UUID uuid29530 = author6337.getUUID();
        ...
        author6331 = new fifthelement.theelement.objects.Author(uuid29534, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid29541 = author6331.getUUID();
        ...
        author6329 = new fifthelement.theelement.objects.Author(uuid29545, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid29552 = author6329.getUUID();
