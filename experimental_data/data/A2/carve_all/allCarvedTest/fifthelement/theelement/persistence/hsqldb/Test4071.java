...
public class Test4071 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_SongPersistenceHSQLDB_getSongsByAlbumUUID_001() throws Exception {
        ...
        java.util.UUID uuid24552 = org.mockito.Mockito.mock(java.util.UUID.class);
        org.mockito.stubbing.Stubber stubber8001 = org.mockito.Mockito.doReturn("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid24553 = stubber8001.when(uuid24552);
        uuid24553.toString();
        ...
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        fifthelement.theelement.objects.Song song3751 = songpersistencehsqldb8.getSongByUUID(uuid24553);
        songpersistencehsqldb8.deleteSong(song3751);
        fifthelement.theelement.objects.Album album1801 = song3751.getAlbum();
        java.util.UUID uuid24579 = album1801.getUUID();
        songpersistencehsqldb8.getSongsByAlbumUUID(uuid24579);
    }
}
