...
public class Test7624 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_011() throws Exception {
        ...
        author409 = new fifthelement.theelement.objects.Author(uuid7628, "");
        java.util.UUID uuid7629 = author409.getUUID();
        ...
        author422 = new fifthelement.theelement.objects.Author(uuid7639, "");
        authorpersistencehsqldb12.getAuthorByUUID(uuid7635);
        java.util.UUID uuid7640 = author422.getUUID();
