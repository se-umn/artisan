...
public class Test5557 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAllAuthors_004() throws Exception {
        ...
        author873 = new fifthelement.theelement.objects.Author(uuid21518, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid21525 = author873.getUUID();
        ...
        author859 = new fifthelement.theelement.objects.Author(uuid21534, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb19.getAuthorByUUID(uuid21530);
        java.util.UUID uuid21537 = author859.getUUID();
        ...
        author868 = new fifthelement.theelement.objects.Author(uuid21550, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb19.getAuthorByUUID(uuid21546);
        java.util.UUID uuid21553 = author868.getUUID();
        ...
        author856 = new fifthelement.theelement.objects.Author(uuid21565, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid21568 = author870.getUUID();
        authorpersistencehsqldb19.getAuthorByUUID(uuid21568);
        java.util.UUID uuid21569 = author856.getUUID();
        ...
        author871 = new fifthelement.theelement.objects.Author(uuid21571, "");
        java.util.UUID uuid21572 = author871.getUUID();
