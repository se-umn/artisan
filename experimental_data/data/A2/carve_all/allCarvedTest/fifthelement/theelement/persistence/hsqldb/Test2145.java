...
public class Test2145 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_019() throws Exception {
        ...
        fifthelement.theelement.objects.Author author1214 = null;
        ...
        author1214 = new fifthelement.theelement.objects.Author(uuid33233, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid33240 = author1214.getUUID();
        ...
        author1216 = new fifthelement.theelement.objects.Author(uuid33254, "");
        java.util.UUID uuid33255 = author1216.getUUID();
        ...
        author1200 = new fifthelement.theelement.objects.Author(uuid33265, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb23.getAuthorByUUID(uuid33261);
        java.util.UUID uuid33268 = author1200.getUUID();
        ...
        author1207 = new fifthelement.theelement.objects.Author(uuid33276, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid33280 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1202 = new fifthelement.theelement.objects.Author(uuid33280, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid33283 = author1207.getUUID();
        authorpersistencehsqldb23.getAuthorByUUID(uuid33283);
        java.util.UUID uuid33284 = author1202.getUUID();
        ...
        author1203 = new fifthelement.theelement.objects.Author(uuid33297, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb23.getAuthorByUUID(uuid33293);
        java.util.UUID uuid33300 = author1203.getUUID();
        ...
        author1217 = new fifthelement.theelement.objects.Author(uuid33302, "");
        java.util.UUID uuid33303 = author1217.getUUID();
        ...
        author1220 = new fifthelement.theelement.objects.Author(uuid33305, "");
        java.util.UUID uuid33306 = author1220.getUUID();
