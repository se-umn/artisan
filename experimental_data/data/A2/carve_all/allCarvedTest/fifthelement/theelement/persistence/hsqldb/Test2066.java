...
public class Test2066 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAllAuthors_003() throws Exception {
        ...
        author831 = new fifthelement.theelement.objects.Author(uuid20734, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid20741 = author831.getUUID();
        ...
        author818 = new fifthelement.theelement.objects.Author(uuid20743, "");
        java.util.UUID uuid20744 = author818.getUUID();
        ...
        author812 = new fifthelement.theelement.objects.Author(uuid20750, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb18.getAuthorByUUID(uuid20746);
        java.util.UUID uuid20753 = author812.getUUID();
        ...
        author833 = new fifthelement.theelement.objects.Author(uuid20755, "");
        java.util.UUID uuid20756 = author833.getUUID();
        ...
        author814 = new fifthelement.theelement.objects.Author(uuid20766, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb18.getAuthorByUUID(uuid20762);
        java.util.UUID uuid20769 = author814.getUUID();
        ...
        author823 = new fifthelement.theelement.objects.Author(uuid20777, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid20781 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author816 = new fifthelement.theelement.objects.Author(uuid20781, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid20784 = author823.getUUID();
        authorpersistencehsqldb18.getAuthorByUUID(uuid20784);
        java.util.UUID uuid20785 = author816.getUUID();
