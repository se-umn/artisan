...
public class Test7096 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AlbumPersistenceHSQLDB_getAlbumByUUID_004() throws Exception {
        ...
        album190 = new fifthelement.theelement.objects.Album(uuid7654, "");
        java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        java.util.UUID uuid7657 = album190.getUUID();
        ...
        album191 = new fifthelement.theelement.objects.Album(uuid7676, "");
        java.util.UUID uuid7677 = album191.getUUID();
