...
public class Test400 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_021() throws Exception {
        ...
        fifthelement.theelement.objects.Author author1374 = null;
        ...
        author1349 = new fifthelement.theelement.objects.Author(uuid37985, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid37992 = author1349.getUUID();
        ...
        author1370 = new fifthelement.theelement.objects.Author(uuid37994, "");
        java.util.UUID uuid37995 = author1370.getUUID();
        ...
        author1359 = new fifthelement.theelement.objects.Author(uuid38001, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb25.getAuthorByUUID(uuid37997);
        java.util.UUID uuid38004 = author1359.getUUID();
        ...
        author1344 = new fifthelement.theelement.objects.Author(uuid38017, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb25.getAuthorByUUID(uuid38013);
        java.util.UUID uuid38020 = author1344.getUUID();
        ...
        author1350 = new fifthelement.theelement.objects.Author(uuid38028, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid38032 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1374 = new fifthelement.theelement.objects.Author(uuid38032, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid38035 = author1350.getUUID();
        authorpersistencehsqldb25.getAuthorByUUID(uuid38035);
        java.util.UUID uuid38036 = author1374.getUUID();
        ...
        author1348 = new fifthelement.theelement.objects.Author(uuid38038, "");
        java.util.UUID uuid38039 = author1348.getUUID();
        ...
        author1368 = new fifthelement.theelement.objects.Author(uuid38049, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb25.getAuthorByUUID(uuid38045);
        java.util.UUID uuid38052 = author1368.getUUID();
        ...
        author1366 = new fifthelement.theelement.objects.Author(uuid38054, "");
        java.util.UUID uuid38055 = author1366.getUUID();
        ...
        author1354 = new fifthelement.theelement.objects.Author(uuid38057, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid38061 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1346 = new fifthelement.theelement.objects.Author(uuid38061, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid38064 = author1354.getUUID();
        authorpersistencehsqldb25.getAuthorByUUID(uuid38064);
        java.util.UUID uuid38065 = author1346.getUUID();
