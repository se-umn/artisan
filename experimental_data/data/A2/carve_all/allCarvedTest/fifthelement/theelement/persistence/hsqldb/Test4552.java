...
public class Test4552 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_023() throws Exception {
        ...
        fifthelement.theelement.objects.Author author1558 = null;
        ...
        author1530 = new fifthelement.theelement.objects.Author(uuid44376, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid44383 = author1530.getUUID();
        ...
        author1554 = new fifthelement.theelement.objects.Author(uuid44385, "");
        java.util.UUID uuid44386 = author1554.getUUID();
        ...
        author1543 = new fifthelement.theelement.objects.Author(uuid44392, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44388);
        java.util.UUID uuid44395 = author1543.getUUID();
        ...
        author1525 = new fifthelement.theelement.objects.Author(uuid44408, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44404);
        java.util.UUID uuid44411 = author1525.getUUID();
        ...
        author1531 = new fifthelement.theelement.objects.Author(uuid44419, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid44423 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1558 = new fifthelement.theelement.objects.Author(uuid44423, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid44426 = author1531.getUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44426);
        java.util.UUID uuid44427 = author1558.getUUID();
        ...
        author1529 = new fifthelement.theelement.objects.Author(uuid44429, "");
        java.util.UUID uuid44430 = author1529.getUUID();
        ...
        author1552 = new fifthelement.theelement.objects.Author(uuid44440, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44436);
        java.util.UUID uuid44443 = author1552.getUUID();
        ...
        author1550 = new fifthelement.theelement.objects.Author(uuid44445, "");
        java.util.UUID uuid44446 = author1550.getUUID();
        ...
        author1537 = new fifthelement.theelement.objects.Author(uuid44448, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid44452 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1527 = new fifthelement.theelement.objects.Author(uuid44452, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid44455 = author1537.getUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44455);
        java.util.UUID uuid44456 = author1527.getUUID();
