...
public class Test6845 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_updateAuthor_001() throws Exception {
        ...
        fifthelement.theelement.objects.Author author6987 = null;
        fifthelement.theelement.objects.Author author6989 = null;
        fifthelement.theelement.objects.Author author6994 = null;
        fifthelement.theelement.objects.Author author6995 = null;
        fifthelement.theelement.objects.Author author7000 = null;
        ...
        author7000 = new fifthelement.theelement.objects.Author(uuid39472, "");
        java.util.UUID uuid39473 = author7000.getUUID();
        ...
        author6995 = new fifthelement.theelement.objects.Author(uuid39479, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb21.getAuthorByUUID(uuid39475);
        java.util.UUID uuid39482 = author6995.getUUID();
        ...
        author6989 = new fifthelement.theelement.objects.Author(uuid39486, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid39493 = author6989.getUUID();
        ...
        author6987 = new fifthelement.theelement.objects.Author(uuid39497, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid39504 = author6987.getUUID();
