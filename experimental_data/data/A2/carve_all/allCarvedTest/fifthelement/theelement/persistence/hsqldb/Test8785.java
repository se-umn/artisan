...
public class Test8785 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_023() throws Exception {
        ...
        fifthelement.theelement.objects.Author author1543 = null;
        ...
        author1534 = new fifthelement.theelement.objects.Author(uuid44376, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid44383 = author1534.getUUID();
        ...
        author1552 = new fifthelement.theelement.objects.Author(uuid44385, "");
        java.util.UUID uuid44386 = author1552.getUUID();
        ...
        author1550 = new fifthelement.theelement.objects.Author(uuid44392, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44388);
        java.util.UUID uuid44395 = author1550.getUUID();
        ...
        author1532 = new fifthelement.theelement.objects.Author(uuid44397, "");
        java.util.UUID uuid44398 = author1532.getUUID();
        ...
        author1530 = new fifthelement.theelement.objects.Author(uuid44408, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44404);
        java.util.UUID uuid44411 = author1530.getUUID();
        ...
        author1543 = new fifthelement.theelement.objects.Author(uuid44419, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid44423 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1547 = new fifthelement.theelement.objects.Author(uuid44423, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid44426 = author1543.getUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44426);
        java.util.UUID uuid44427 = author1547.getUUID();
        ...
        author1528 = new fifthelement.theelement.objects.Author(uuid44429, "");
        java.util.UUID uuid44430 = author1528.getUUID();
        ...
        author1542 = new fifthelement.theelement.objects.Author(uuid44440, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb27.getAuthorByUUID(uuid44436);
        java.util.UUID uuid44443 = author1542.getUUID();
        ...
        author1527 = new fifthelement.theelement.objects.Author(uuid44445, "");
        java.util.UUID uuid44446 = author1527.getUUID();
        ...
        author1546 = new fifthelement.theelement.objects.Author(uuid44448, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid44455 = author1546.getUUID();
        ...
        author1535 = new fifthelement.theelement.objects.Author(uuid44460, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid44464 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        java.util.UUID uuid44465 = author1535.getUUID();
