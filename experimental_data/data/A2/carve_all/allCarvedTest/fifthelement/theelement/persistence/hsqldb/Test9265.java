...
public class Test9265 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_013() throws Exception {
        ...
        fifthelement.theelement.objects.Author author596 = null;
        ...
        author592 = new fifthelement.theelement.objects.Author(uuid10045, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid10052 = author592.getUUID();
        ...
        author596 = new fifthelement.theelement.objects.Author(uuid10054, "");
        java.util.UUID uuid10055 = author596.getUUID();
        ...
        author587 = new fifthelement.theelement.objects.Author(uuid10061, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb13.getAuthorByUUID(uuid10057);
        java.util.UUID uuid10064 = author587.getUUID();
        ...
        author593 = new fifthelement.theelement.objects.Author(uuid10068, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid10075 = author593.getUUID();
        ...
        author601 = new fifthelement.theelement.objects.Author(uuid10079, "");
        java.util.UUID uuid10080 = author601.getUUID();
