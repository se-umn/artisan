...
public class Test8658 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAllAuthors_004() throws Exception {
        ...
        fifthelement.theelement.objects.Author author864 = null;
        ...
        author871 = new fifthelement.theelement.objects.Author(uuid21534, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb19.getAuthorByUUID(uuid21530);
        java.util.UUID uuid21537 = author871.getUUID();
        ...
        author864 = new fifthelement.theelement.objects.Author(uuid21539, "");
        java.util.UUID uuid21540 = author864.getUUID();
        ...
        author862 = new fifthelement.theelement.objects.Author(uuid21550, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb19.getAuthorByUUID(uuid21546);
        java.util.UUID uuid21553 = author862.getUUID();
        ...
        author860 = new fifthelement.theelement.objects.Author(uuid21561, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid21565 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author866 = new fifthelement.theelement.objects.Author(uuid21565, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid21568 = author860.getUUID();
        authorpersistencehsqldb19.getAuthorByUUID(uuid21568);
        java.util.UUID uuid21569 = author866.getUUID();
