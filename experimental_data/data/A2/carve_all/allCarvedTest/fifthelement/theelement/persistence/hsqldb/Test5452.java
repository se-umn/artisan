...
public class Test5452 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_012() throws Exception {
        ...
        author467 = new fifthelement.theelement.objects.Author(uuid8892, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid8899 = author467.getUUID();
        ...
        author460 = new fifthelement.theelement.objects.Author(uuid8901, "");
        java.util.UUID uuid8902 = author460.getUUID();
        ...
        author457 = new fifthelement.theelement.objects.Author(uuid8908, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb13.getAuthorByUUID(uuid8904);
        java.util.UUID uuid8911 = author457.getUUID();
        ...
        author456 = new fifthelement.theelement.objects.Author(uuid8913, "");
        java.util.UUID uuid8914 = author456.getUUID();
        ...
        author464 = new fifthelement.theelement.objects.Author(uuid8924, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb13.getAuthorByUUID(uuid8920);
        java.util.UUID uuid8927 = author464.getUUID();
