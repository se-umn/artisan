...
public class Test6841 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_020() throws Exception {
        ...
        fifthelement.theelement.objects.Author author6950 = null;
        ...
        author6950 = new fifthelement.theelement.objects.Author(uuid38818, "");
        java.util.UUID uuid38819 = author6950.getUUID();
        ...
        author6945 = new fifthelement.theelement.objects.Author(uuid38825, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb20.getAuthorByUUID(uuid38821);
        java.util.UUID uuid38828 = author6945.getUUID();
        ...
        author6939 = new fifthelement.theelement.objects.Author(uuid38832, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid38839 = author6939.getUUID();
        ...
        author6937 = new fifthelement.theelement.objects.Author(uuid38843, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid38850 = author6937.getUUID();
