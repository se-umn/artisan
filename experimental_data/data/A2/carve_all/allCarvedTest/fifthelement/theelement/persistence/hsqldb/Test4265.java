...
public class Test4265 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_009() throws Exception {
        ...
        author286 = new fifthelement.theelement.objects.Author(uuid4226, "");
        java.util.UUID uuid4227 = author286.getUUID();
        ...
        author291 = new fifthelement.theelement.objects.Author(uuid4233, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb9.getAuthorByUUID(uuid4229);
        java.util.UUID uuid4236 = author291.getUUID();
        ...
        author284 = new fifthelement.theelement.objects.Author(uuid4238, "");
        java.util.UUID uuid4239 = author284.getUUID();
