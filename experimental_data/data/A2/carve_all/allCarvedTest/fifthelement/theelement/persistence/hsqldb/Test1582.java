...
public class Test1582 {
     ...
     * Method invocation under test: <fifthelement.theelement.persistence.hsqldb.AuthorPersistenceHSQLDB: fifthelement.theelement.objects.Author getAuthorByUUID(java.util.UUID)>_556_1110
     */
    @Test(timeout = 4000)
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_007() throws Exception {
        ...
        author207 = new fifthelement.theelement.objects.Author(uuid2682, "");
        java.util.UUID uuid2683 = author207.getUUID();
