...
public class Test8514 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAllAuthors_001() throws Exception {
        ...
        author325 = new fifthelement.theelement.objects.Author(uuid5247, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid5254 = author325.getUUID();
        ...
        author329 = new fifthelement.theelement.objects.Author(uuid5268, "");
        java.util.UUID uuid5269 = author329.getUUID();
