...
public class Test1912 {
     ...
     * Method invocation under test: <fifthelement.theelement.persistence.hsqldb.AuthorPersistenceHSQLDB: fifthelement.theelement.objects.Author getAuthorByUUID(java.util.UUID)>_570_1137
     */
    @Test(timeout = 4000)
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_009() throws Exception {
        ...
        fifthelement.theelement.objects.Author author281 = null;
        fifthelement.theelement.objects.Author author287 = null;
        fifthelement.theelement.objects.Author author290 = null;
        ...
        author287 = new fifthelement.theelement.objects.Author(uuid4217, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid4224 = author287.getUUID();
        ...
        author291 = new fifthelement.theelement.objects.Author(uuid4226, "");
        java.util.UUID uuid4227 = author291.getUUID();
        ...
        author281 = new fifthelement.theelement.objects.Author(uuid4233, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb9.getAuthorByUUID(uuid4229);
        java.util.UUID uuid4236 = author281.getUUID();
        ...
        author290 = new fifthelement.theelement.objects.Author(uuid4238, "");
        java.util.UUID uuid4239 = author290.getUUID();
        authorpersistencehsqldb9.getAuthorByUUID(uuid4239);
    }
}
