...
public class Test377 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_019() throws Exception {
        ...
        fifthelement.theelement.objects.Author author1203 = null;
        fifthelement.theelement.objects.Author author1204 = null;
        fifthelement.theelement.objects.Author author1207 = null;
        ...
        fifthelement.theelement.objects.Author author1218 = null;
        fifthelement.theelement.objects.Author author1220 = null;
        fifthelement.theelement.objects.Author author1222 = null;
        fifthelement.theelement.objects.Author author1226 = null;
        ...
        author1202 = new fifthelement.theelement.objects.Author(uuid33233, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid33240 = author1202.getUUID();
        ...
        author1211 = new fifthelement.theelement.objects.Author(uuid33249, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb23.getAuthorByUUID(uuid33245);
        java.util.UUID uuid33252 = author1211.getUUID();
        ...
        author1204 = new fifthelement.theelement.objects.Author(uuid33254, "");
        java.util.UUID uuid33255 = author1204.getUUID();
        ...
        author1199 = new fifthelement.theelement.objects.Author(uuid33265, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb23.getAuthorByUUID(uuid33261);
        java.util.UUID uuid33268 = author1199.getUUID();
        ...
        author1203 = new fifthelement.theelement.objects.Author(uuid33276, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid33280 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1226 = new fifthelement.theelement.objects.Author(uuid33280, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid33283 = author1203.getUUID();
        authorpersistencehsqldb23.getAuthorByUUID(uuid33283);
        java.util.UUID uuid33284 = author1226.getUUID();
        ...
        author1201 = new fifthelement.theelement.objects.Author(uuid33286, "");
        java.util.UUID uuid33287 = author1201.getUUID();
        ...
        author1220 = new fifthelement.theelement.objects.Author(uuid33297, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb23.getAuthorByUUID(uuid33293);
        java.util.UUID uuid33300 = author1220.getUUID();
        ...
        author1218 = new fifthelement.theelement.objects.Author(uuid33302, "");
        java.util.UUID uuid33303 = author1218.getUUID();
        ...
        author1207 = new fifthelement.theelement.objects.Author(uuid33305, "");
        java.util.UUID uuid33306 = author1207.getUUID();
