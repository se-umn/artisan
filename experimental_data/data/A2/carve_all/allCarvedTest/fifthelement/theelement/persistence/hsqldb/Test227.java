...
public class Test227 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAllAuthors_002() throws Exception {
        ...
        author556 = new fifthelement.theelement.objects.Author(uuid11646, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid11653 = author556.getUUID();
        ...
        author560 = new fifthelement.theelement.objects.Author(uuid11655, "");
        java.util.UUID uuid11656 = author560.getUUID();
        ...
        author551 = new fifthelement.theelement.objects.Author(uuid11662, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb14.getAuthorByUUID(uuid11658);
        java.util.UUID uuid11665 = author551.getUUID();
        ...
        author558 = new fifthelement.theelement.objects.Author(uuid11667, "");
        java.util.UUID uuid11668 = author558.getUUID();
        ...
        author549 = new fifthelement.theelement.objects.Author(uuid11678, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb14.getAuthorByUUID(uuid11674);
        java.util.UUID uuid11681 = author549.getUUID();
