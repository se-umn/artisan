...
public class Test9884 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_017() throws Exception {
        ...
        author6400 = new fifthelement.theelement.objects.Author(uuid31058, "");
        java.util.UUID uuid31059 = author6400.getUUID();
        ...
        author6388 = new fifthelement.theelement.objects.Author(uuid31065, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb17.getAuthorByUUID(uuid31061);
        java.util.UUID uuid31068 = author6388.getUUID();
        ...
        author6397 = new fifthelement.theelement.objects.Author(uuid31072, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid31079 = author6397.getUUID();
        ...
        author6406 = new fifthelement.theelement.objects.Author(uuid31083, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid31090 = author6406.getUUID();
