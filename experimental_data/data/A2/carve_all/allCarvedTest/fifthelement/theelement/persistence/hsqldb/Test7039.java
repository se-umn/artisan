...
public class Test7039 {
     ...
     * Method invocation under test: <fifthelement.theelement.persistence.hsqldb.AuthorPersistenceHSQLDB: fifthelement.theelement.objects.Author getAuthorByUUID(java.util.UUID)>_490_976
     */
    @Test(timeout = 4000)
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_008() throws Exception {
        ...
        author244 = new fifthelement.theelement.objects.Author(uuid3384, "");
        authorpersistencehsqldb8.getAuthorByUUID(uuid3380);
        java.util.UUID uuid3385 = author244.getUUID();
