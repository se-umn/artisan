...
public class Test8581 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAllAuthors_002() throws Exception {
        ...
        author559 = new fifthelement.theelement.objects.Author(uuid11655, "");
        java.util.UUID uuid11656 = author559.getUUID();
        ...
        author557 = new fifthelement.theelement.objects.Author(uuid11662, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb14.getAuthorByUUID(uuid11658);
        java.util.UUID uuid11665 = author557.getUUID();
        ...
        author552 = new fifthelement.theelement.objects.Author(uuid11667, "");
        java.util.UUID uuid11668 = author552.getUUID();
