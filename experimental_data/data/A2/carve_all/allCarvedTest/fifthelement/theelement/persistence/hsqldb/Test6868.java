...
public class Test6868 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_SongPersistenceHSQLDB_updateSong_001() throws Exception {
        ...
        fifthelement.theelement.objects.Author author7061 = null;
        ...
        author7060 = new fifthelement.theelement.objects.Author(uuid43216, "");
        album3324 = new fifthelement.theelement.objects.Album(uuid43215, "A Head Full of Dreams", author7060, list137, 10);
        song7108.setAlbum(album3324);
        song7108.getAuthor();
        ...
        author7061 = new fifthelement.theelement.objects.Author(uuid43218, "Coldplay", 10);
        song7108.setAuthor(author7061);
