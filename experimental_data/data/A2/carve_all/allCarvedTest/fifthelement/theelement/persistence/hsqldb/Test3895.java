...
public class Test3895 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_010() throws Exception {
        ...
        author422 = new fifthelement.theelement.objects.Author(uuid6119, "");
        java.util.UUID uuid6120 = author422.getUUID();
        ...
        author418 = new fifthelement.theelement.objects.Author(uuid6126, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb10.getAuthorByUUID(uuid6122);
        java.util.UUID uuid6129 = author418.getUUID();
        ...
        author426 = new fifthelement.theelement.objects.Author(uuid6133, "");
        java.util.UUID uuid6134 = author426.getUUID();
