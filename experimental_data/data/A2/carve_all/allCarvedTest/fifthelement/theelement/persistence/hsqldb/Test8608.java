...
public class Test8608 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_013() throws Exception {
        ...
        fifthelement.theelement.objects.Author author634 = null;
        ...
        author634 = new fifthelement.theelement.objects.Author(uuid14763, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid14770 = author634.getUUID();
        ...
        author637 = new fifthelement.theelement.objects.Author(uuid14772, "");
        java.util.UUID uuid14773 = author637.getUUID();
        ...
        author635 = new fifthelement.theelement.objects.Author(uuid14779, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb15.getAuthorByUUID(uuid14775);
        java.util.UUID uuid14782 = author635.getUUID();
        ...
        author629 = new fifthelement.theelement.objects.Author(uuid14784, "");
        java.util.UUID uuid14785 = author629.getUUID();
        ...
        author627 = new fifthelement.theelement.objects.Author(uuid14795, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb15.getAuthorByUUID(uuid14791);
        java.util.UUID uuid14798 = author627.getUUID();
        ...
        author625 = new fifthelement.theelement.objects.Author(uuid14806, "");
        java.util.UUID uuid14807 = author625.getUUID();
