...
public class Test2045 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_015() throws Exception {
        ...
        fifthelement.theelement.objects.Author author739 = null;
        ...
        author754 = new fifthelement.theelement.objects.Author(uuid18000, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid18007 = author754.getUUID();
        ...
        author741 = new fifthelement.theelement.objects.Author(uuid18009, "");
        java.util.UUID uuid18010 = author741.getUUID();
        ...
        author735 = new fifthelement.theelement.objects.Author(uuid18016, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb17.getAuthorByUUID(uuid18012);
        java.util.UUID uuid18019 = author735.getUUID();
        ...
        author756 = new fifthelement.theelement.objects.Author(uuid18021, "");
        java.util.UUID uuid18022 = author756.getUUID();
        ...
        author737 = new fifthelement.theelement.objects.Author(uuid18032, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb17.getAuthorByUUID(uuid18028);
        java.util.UUID uuid18035 = author737.getUUID();
        ...
        author746 = new fifthelement.theelement.objects.Author(uuid18043, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid18047 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author739 = new fifthelement.theelement.objects.Author(uuid18047, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid18050 = author746.getUUID();
        authorpersistencehsqldb17.getAuthorByUUID(uuid18050);
        java.util.UUID uuid18051 = author739.getUUID();
        ...
        author738 = new fifthelement.theelement.objects.Author(uuid18053, "");
        java.util.UUID uuid18054 = author738.getUUID();
