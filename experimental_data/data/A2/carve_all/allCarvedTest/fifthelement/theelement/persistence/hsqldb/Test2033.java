...
public class Test2033 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_014() throws Exception {
        ...
        fifthelement.theelement.objects.Author author679 = null;
        fifthelement.theelement.objects.Author author681 = null;
        fifthelement.theelement.objects.Author author682 = null;
        fifthelement.theelement.objects.Author author684 = null;
        fifthelement.theelement.objects.Author author689 = null;
        ...
        author696 = new fifthelement.theelement.objects.Author(uuid16278, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid16285 = author696.getUUID();
        ...
        author684 = new fifthelement.theelement.objects.Author(uuid16287, "");
        java.util.UUID uuid16288 = author684.getUUID();
        ...
        author679 = new fifthelement.theelement.objects.Author(uuid16294, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb16.getAuthorByUUID(uuid16290);
        java.util.UUID uuid16297 = author679.getUUID();
        ...
        author698 = new fifthelement.theelement.objects.Author(uuid16299, "");
        java.util.UUID uuid16300 = author698.getUUID();
        ...
        author681 = new fifthelement.theelement.objects.Author(uuid16310, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb16.getAuthorByUUID(uuid16306);
        java.util.UUID uuid16313 = author681.getUUID();
        ...
        author689 = new fifthelement.theelement.objects.Author(uuid16321, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid16325 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author682 = new fifthelement.theelement.objects.Author(uuid16325, "");
        java.util.UUID uuid16326 = author689.getUUID();
        authorpersistencehsqldb16.getAuthorByUUID(uuid16326);
        java.util.UUID uuid16327 = author682.getUUID();
