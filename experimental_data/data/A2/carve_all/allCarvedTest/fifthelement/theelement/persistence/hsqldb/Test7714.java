...
public class Test7714 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_015() throws Exception {
        ...
        fifthelement.theelement.objects.Author author740 = null;
        ...
        author753 = new fifthelement.theelement.objects.Author(uuid18032, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb17.getAuthorByUUID(uuid18028);
        java.util.UUID uuid18035 = author753.getUUID();
        ...
        author740 = new fifthelement.theelement.objects.Author(uuid18043, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid18047 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author755 = new fifthelement.theelement.objects.Author(uuid18047, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid18050 = author740.getUUID();
        authorpersistencehsqldb17.getAuthorByUUID(uuid18050);
        java.util.UUID uuid18051 = author755.getUUID();
        ...
        author754 = new fifthelement.theelement.objects.Author(uuid18053, "");
        java.util.UUID uuid18054 = author754.getUUID();
