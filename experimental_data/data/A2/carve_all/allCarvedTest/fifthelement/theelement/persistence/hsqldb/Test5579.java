...
public class Test5579 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_016() throws Exception {
        ...
        author929 = new fifthelement.theelement.objects.Author(uuid24175, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid24182 = author929.getUUID();
        ...
        author914 = new fifthelement.theelement.objects.Author(uuid24191, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb20.getAuthorByUUID(uuid24187);
        java.util.UUID uuid24194 = author914.getUUID();
        ...
        author913 = new fifthelement.theelement.objects.Author(uuid24196, "");
        java.util.UUID uuid24197 = author913.getUUID();
        ...
        author924 = new fifthelement.theelement.objects.Author(uuid24207, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb20.getAuthorByUUID(uuid24203);
        java.util.UUID uuid24210 = author924.getUUID();
        ...
        author926 = new fifthelement.theelement.objects.Author(uuid24218, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid24222 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author911 = new fifthelement.theelement.objects.Author(uuid24222, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid24225 = author926.getUUID();
        authorpersistencehsqldb20.getAuthorByUUID(uuid24225);
        java.util.UUID uuid24226 = author911.getUUID();
        ...
        author927 = new fifthelement.theelement.objects.Author(uuid24228, "");
        java.util.UUID uuid24229 = author927.getUUID();
