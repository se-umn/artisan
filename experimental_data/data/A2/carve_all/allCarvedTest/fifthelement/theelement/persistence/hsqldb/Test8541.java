...
public class Test8541 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_011() throws Exception {
        ...
        author417 = new fifthelement.theelement.objects.Author(uuid7616, "");
        java.util.UUID uuid7617 = author417.getUUID();
        ...
        author415 = new fifthelement.theelement.objects.Author(uuid7623, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb12.getAuthorByUUID(uuid7619);
        java.util.UUID uuid7626 = author415.getUUID();
        ...
        author410 = new fifthelement.theelement.objects.Author(uuid7628, "");
        java.util.UUID uuid7629 = author410.getUUID();
