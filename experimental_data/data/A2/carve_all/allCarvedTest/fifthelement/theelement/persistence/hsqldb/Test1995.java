...
public class Test1995 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAllAuthors_002() throws Exception {
        ...
        fifthelement.theelement.objects.Author author548 = null;
        ...
        author561 = new fifthelement.theelement.objects.Author(uuid11646, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid11653 = author561.getUUID();
        ...
        author552 = new fifthelement.theelement.objects.Author(uuid11655, "");
        java.util.UUID uuid11656 = author552.getUUID();
        ...
        author548 = new fifthelement.theelement.objects.Author(uuid11662, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb14.getAuthorByUUID(uuid11658);
        java.util.UUID uuid11665 = author548.getUUID();
        ...
        author563 = new fifthelement.theelement.objects.Author(uuid11667, "");
        java.util.UUID uuid11668 = author563.getUUID();
        ...
        author550 = new fifthelement.theelement.objects.Author(uuid11678, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb14.getAuthorByUUID(uuid11674);
        java.util.UUID uuid11681 = author550.getUUID();
