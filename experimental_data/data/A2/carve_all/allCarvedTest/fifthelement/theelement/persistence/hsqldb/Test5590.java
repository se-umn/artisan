...
public class Test5590 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_017() throws Exception {
        ...
        fifthelement.theelement.objects.Author author974 = null;
        ...
        author977 = new fifthelement.theelement.objects.Author(uuid26149, "");
        java.util.UUID uuid26150 = author977.getUUID();
        ...
        author975 = new fifthelement.theelement.objects.Author(uuid26156, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb21.getAuthorByUUID(uuid26152);
        java.util.UUID uuid26159 = author975.getUUID();
        ...
        author987 = new fifthelement.theelement.objects.Author(uuid26161, "");
        java.util.UUID uuid26162 = author987.getUUID();
        ...
        author993 = new fifthelement.theelement.objects.Author(uuid26172, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb21.getAuthorByUUID(uuid26168);
        java.util.UUID uuid26175 = author993.getUUID();
        ...
        author994 = new fifthelement.theelement.objects.Author(uuid26183, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        java.util.UUID uuid26187 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author985 = new fifthelement.theelement.objects.Author(uuid26187, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid26190 = author994.getUUID();
        authorpersistencehsqldb21.getAuthorByUUID(uuid26190);
        java.util.UUID uuid26191 = author985.getUUID();
        ...
        author995 = new fifthelement.theelement.objects.Author(uuid26193, "");
        java.util.UUID uuid26194 = author995.getUUID();
        ...
        author974 = new fifthelement.theelement.objects.Author(uuid26204, "");
        authorpersistencehsqldb21.getAuthorByUUID(uuid26200);
        java.util.UUID uuid26205 = author974.getUUID();
