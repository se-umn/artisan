...
public class Test6832 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_019() throws Exception {
        ...
        fifthelement.theelement.objects.Author author6866 = null;
        fifthelement.theelement.objects.Author author6868 = null;
        fifthelement.theelement.objects.Author author6873 = null;
        fifthelement.theelement.objects.Author author6874 = null;
        fifthelement.theelement.objects.Author author6878 = null;
        ...
        author6873 = new fifthelement.theelement.objects.Author(uuid37483, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid37490 = author6873.getUUID();
        ...
        author6878 = new fifthelement.theelement.objects.Author(uuid37492, "");
        java.util.UUID uuid37493 = author6878.getUUID();
        ...
        author6874 = new fifthelement.theelement.objects.Author(uuid37499, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb19.getAuthorByUUID(uuid37495);
        java.util.UUID uuid37502 = author6874.getUUID();
        ...
        author6868 = new fifthelement.theelement.objects.Author(uuid37506, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid37513 = author6868.getUUID();
        ...
        author6866 = new fifthelement.theelement.objects.Author(uuid37517, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid37524 = author6866.getUUID();
