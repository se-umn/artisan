...
public class Test8553 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_012() throws Exception {
        ...
        author466 = new fifthelement.theelement.objects.Author(uuid8901, "");
        java.util.UUID uuid8902 = author466.getUUID();
        ...
        author464 = new fifthelement.theelement.objects.Author(uuid8908, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb13.getAuthorByUUID(uuid8904);
        java.util.UUID uuid8911 = author464.getUUID();
        ...
        author459 = new fifthelement.theelement.objects.Author(uuid8913, "");
        java.util.UUID uuid8914 = author459.getUUID();
