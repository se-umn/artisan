...
public class Test5440 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_getAuthorByUUID_011() throws Exception {
        ...
        author412 = new fifthelement.theelement.objects.Author(uuid7616, "");
        java.util.UUID uuid7617 = author412.getUUID();
        ...
        author409 = new fifthelement.theelement.objects.Author(uuid7623, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb12.getAuthorByUUID(uuid7619);
        java.util.UUID uuid7626 = author409.getUUID();
        ...
        author408 = new fifthelement.theelement.objects.Author(uuid7628, "");
        java.util.UUID uuid7629 = author408.getUUID();
        ...
        author416 = new fifthelement.theelement.objects.Author(uuid7639, "");
        authorpersistencehsqldb12.getAuthorByUUID(uuid7635);
        java.util.UUID uuid7640 = author416.getUUID();
