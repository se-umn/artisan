...
public class Test5710 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_007() throws Exception {
        ...
        song273 = new fifthelement.theelement.objects.Song(uuid50645, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1767, album590, "Hiphop", 3, 1.5);
        arraylist420.add(song273);
        java.util.UUID uuid50647 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song274 = new fifthelement.theelement.objects.Song(uuid50647, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1766, album590, "", 3, 4.5);
        arraylist420.add(song274);
        java.util.UUID uuid50648 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song271 = new fifthelement.theelement.objects.Song(uuid50648, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1766, album590, "Classical", 4, 2.0);
        ...
        author1763 = new fifthelement.theelement.objects.Author(uuid50650, "");
        java.util.UUID uuid50651 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album589 = new fifthelement.theelement.objects.Album(uuid50651, "");
        song272 = new fifthelement.theelement.objects.Song(uuid50649, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1763, album589, "Pop", 10, 3.5);
        ...
        song271.getAlbum();
        song272.getAuthor();
        fifthelement.theelement.objects.Author author1775 = song272.getAuthor();
        author1775.getUUID();
        ...
        song272.setAuthor(author1769);
        song272.getAlbum();
        fifthelement.theelement.objects.Album album595 = song272.getAlbum();
        album595.getUUID();
        ...
        author1768 = new fifthelement.theelement.objects.Author(uuid50658, "");
        album588 = new fifthelement.theelement.objects.Album(uuid50657, "A Head Full of Dreams", author1768, list81, 10);
        album588.getAuthor();
        ...
        album588.setAuthor(author1764);
        song272.setAlbum(album588);
        song274.compareTo(song273);
