...
public class Test3167 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_007() throws Exception {
        ...
        author831 = new fifthelement.theelement.objects.Author(uuid14518, "");
        song189 = new fifthelement.theelement.objects.Song(uuid14517, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author831, album311, "Hiphop", 3, 1.5);
        arraylist77.add(song189);
        java.util.UUID uuid14519 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song190 = new fifthelement.theelement.objects.Song(uuid14519, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author828, album311, "", 3, 4.5);
        arraylist77.add(song190);
        java.util.UUID uuid14520 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song191 = new fifthelement.theelement.objects.Song(uuid14520, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author828, album311, "Classical", 4, 2.0);
        ...
        author829 = new fifthelement.theelement.objects.Author(uuid14522, "");
        java.util.UUID uuid14523 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album310 = new fifthelement.theelement.objects.Album(uuid14523, "");
        song188 = new fifthelement.theelement.objects.Song(uuid14521, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author829, album310, "Pop", 10, 3.5);
        arraylist77.add(song188);
        arraylist77.iterator();
        song189.getAuthor();
        fifthelement.theelement.objects.Author author834 = song189.getAuthor();
        author834.getUUID();
        java.util.UUID uuid14525 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author832 = new fifthelement.theelement.objects.Author(uuid14525, "Childish Gambino", 3);
        song189.setAuthor(author832);
        song189.getAlbum();
        song190.getAuthor();
        song190.getAlbum();
        song191.getAuthor();
        song191.getAlbum();
        song188.getAuthor();
        fifthelement.theelement.objects.Author author838 = song188.getAuthor();
        author838.getUUID();
        java.util.UUID uuid14527 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author826 = new fifthelement.theelement.objects.Author(uuid14527, "Coldplay", 10);
        song188.setAuthor(author826);
        song188.getAlbum();
        fifthelement.theelement.objects.Album album317 = song188.getAlbum();
        album317.getUUID();
        ...
        author827 = new fifthelement.theelement.objects.Author(uuid14530, "");
        album312 = new fifthelement.theelement.objects.Album(uuid14529, "A Head Full of Dreams", author827, list32, 10);
        album312.getAuthor();
        fifthelement.theelement.objects.Author author840 = album312.getAuthor();
        author840.getUUID();
        java.util.UUID uuid14532 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author830 = new fifthelement.theelement.objects.Author(uuid14532, "Coldplay", 10);
        album312.setAuthor(author830);
        song188.setAlbum(album312);
        song190.compareTo(song189);
        song191.compareTo(song190);
