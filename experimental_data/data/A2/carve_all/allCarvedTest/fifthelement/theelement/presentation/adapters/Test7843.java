...
public class Test7843 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_004() throws Exception {
        ...
        author1421 = new fifthelement.theelement.objects.Author(uuid39365, "");
        song209 = new fifthelement.theelement.objects.Song(uuid39364, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1421, album481, "Hiphop", 3, 1.5);
        arraylist343.add(song209);
        java.util.UUID uuid39366 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song211 = new fifthelement.theelement.objects.Song(uuid39366, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1420, album481, "", 3, 4.5);
        arraylist343.add(song211);
        java.util.UUID uuid39367 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song210 = new fifthelement.theelement.objects.Song(uuid39367, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1420, album481, "Classical", 4, 2.0);
        ...
        album483 = new fifthelement.theelement.objects.Album(uuid39370, "");
        song208 = new fifthelement.theelement.objects.Song(uuid39368, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1422, album483, "Pop", 10, 3.5);
        ...
        song210.getAlbum();
        song208.getAuthor();
        fifthelement.theelement.objects.Author author1428 = song208.getAuthor();
        author1428.getUUID();
        ...
        song208.setAuthor(author1416);
        song208.getAlbum();
        fifthelement.theelement.objects.Album album488 = song208.getAlbum();
        album488.getUUID();
        ...
        author1419 = new fifthelement.theelement.objects.Author(uuid39377, "");
        album482 = new fifthelement.theelement.objects.Album(uuid39376, "A Head Full of Dreams", author1419, list72, 10);
        album482.getAuthor();
        ...
        author1418 = new fifthelement.theelement.objects.Author(uuid39379, "Coldplay", 10);
        album482.setAuthor(author1418);
        song208.setAlbum(album482);
