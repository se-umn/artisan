...
public class Test457 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_007() throws Exception {
        ...
        author1768 = new fifthelement.theelement.objects.Author(uuid50646, "");
        song271 = new fifthelement.theelement.objects.Song(uuid50645, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1768, album590, "Hiphop", 3, 1.5);
        arraylist420.add(song271);
        java.util.UUID uuid50647 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song274 = new fifthelement.theelement.objects.Song(uuid50647, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1769, album590, "", 3, 4.5);
        arraylist420.add(song274);
        java.util.UUID uuid50648 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song272 = new fifthelement.theelement.objects.Song(uuid50648, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1769, album590, "Classical", 4, 2.0);
        ...
        song273 = new fifthelement.theelement.objects.Song(uuid50649, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1764, album589, "Pop", 10, 3.5);
        arraylist420.add(song273);
        arraylist420.iterator();
        song271.getAuthor();
        fifthelement.theelement.objects.Author author1771 = song271.getAuthor();
        author1771.getUUID();
        ...
        author1766 = new fifthelement.theelement.objects.Author(uuid50655, "Coldplay", 10);
        song273.setAuthor(author1766);
        song273.getAlbum();
        ...
        album588 = new fifthelement.theelement.objects.Album(uuid50657, "A Head Full of Dreams", author1767, list81, 10);
        album588.getAuthor();
        ...
        author1763 = new fifthelement.theelement.objects.Author(uuid50660, "Coldplay", 10);
        album588.setAuthor(author1763);
        song273.setAlbum(album588);
        song274.compareTo(song271);
        song272.compareTo(song274);
