...
public class Test5615 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_002() throws Exception {
        ...
        author1155 = new fifthelement.theelement.objects.Author(uuid30852, "");
        song171 = new fifthelement.theelement.objects.Song(uuid30851, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1155, album410, "Hiphop", 3, 1.5);
        arraylist272.add(song171);
        java.util.UUID uuid30853 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song170 = new fifthelement.theelement.objects.Song(uuid30853, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1157, album410, "", 3, 4.5);
        arraylist272.add(song170);
        java.util.UUID uuid30854 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song168 = new fifthelement.theelement.objects.Song(uuid30854, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1157, album410, "Classical", 4, 2.0);
        ...
        author1153 = new fifthelement.theelement.objects.Author(uuid30856, "");
        java.util.UUID uuid30857 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album412 = new fifthelement.theelement.objects.Album(uuid30857, "");
        song169 = new fifthelement.theelement.objects.Song(uuid30855, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1153, album412, "Pop", 10, 3.5);
        arraylist272.add(song169);
        arraylist272.iterator();
        song171.getAuthor();
        fifthelement.theelement.objects.Author author1161 = song171.getAuthor();
        author1161.getUUID();
        java.util.UUID uuid30859 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author1156 = new fifthelement.theelement.objects.Author(uuid30859, "Childish Gambino", 3);
        song171.setAuthor(author1156);
        song171.getAlbum();
        song170.getAuthor();
        song170.getAlbum();
        song168.getAuthor();
        song168.getAlbum();
        song169.getAuthor();
        fifthelement.theelement.objects.Author author1165 = song169.getAuthor();
        author1165.getUUID();
        java.util.UUID uuid30861 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1154 = new fifthelement.theelement.objects.Author(uuid30861, "Coldplay", 10);
        song169.setAuthor(author1154);
        song169.getAlbum();
        fifthelement.theelement.objects.Album album417 = song169.getAlbum();
        album417.getUUID();
        ...
        author1159 = new fifthelement.theelement.objects.Author(uuid30864, "");
        album411 = new fifthelement.theelement.objects.Album(uuid30863, "A Head Full of Dreams", author1159, list65, 10);
        album411.getAuthor();
        fifthelement.theelement.objects.Author author1167 = album411.getAuthor();
        author1167.getUUID();
        java.util.UUID uuid30866 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1158 = new fifthelement.theelement.objects.Author(uuid30866, "Coldplay", 10);
        album411.setAuthor(author1158);
        song169.setAlbum(album411);
        song170.compareTo(song171);
        song168.compareTo(song170);
        song169.compareTo(song168);
