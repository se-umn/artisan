...
public class Test7894 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_007() throws Exception {
        ...
        author1764 = new fifthelement.theelement.objects.Author(uuid50646, "");
        song274 = new fifthelement.theelement.objects.Song(uuid50645, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1764, album589, "Hiphop", 3, 1.5);
        arraylist420.add(song274);
        java.util.UUID uuid50647 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song272 = new fifthelement.theelement.objects.Song(uuid50647, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1767, album589, "", 3, 4.5);
        arraylist420.add(song272);
        java.util.UUID uuid50648 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song271 = new fifthelement.theelement.objects.Song(uuid50648, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1767, album589, "Classical", 4, 2.0);
        ...
        author1768 = new fifthelement.theelement.objects.Author(uuid50653, "Childish Gambino", 3);
        song274.setAuthor(author1768);
        song274.getAlbum();
        song272.getAuthor();
        song272.getAlbum();
        song271.getAuthor();
        ...
        author1763 = new fifthelement.theelement.objects.Author(uuid50655, "Coldplay", 10);
        ...
        album590 = new fifthelement.theelement.objects.Album(uuid50657, "A Head Full of Dreams", author1765, list81, 10);
        album590.getAuthor();
        fifthelement.theelement.objects.Author author1777 = album590.getAuthor();
        author1777.getUUID();
        java.util.UUID uuid50660 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1769 = new fifthelement.theelement.objects.Author(uuid50660, "Coldplay", 10);
        album590.setAuthor(author1769);
        song273.setAlbum(album590);
        song272.compareTo(song274);
        song271.compareTo(song272);
        song273.compareTo(song271);
