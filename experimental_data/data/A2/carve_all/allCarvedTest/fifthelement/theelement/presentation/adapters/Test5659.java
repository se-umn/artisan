...
public class Test5659 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_004() throws Exception {
        ...
        author1420 = new fifthelement.theelement.objects.Author(uuid39365, "");
        song211 = new fifthelement.theelement.objects.Song(uuid39364, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1420, album483, "Hiphop", 3, 1.5);
        arraylist343.add(song211);
        java.util.UUID uuid39366 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song208 = new fifthelement.theelement.objects.Song(uuid39366, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1421, album483, "", 3, 4.5);
        arraylist343.add(song208);
        java.util.UUID uuid39367 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song209 = new fifthelement.theelement.objects.Song(uuid39367, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1421, album483, "Classical", 4, 2.0);
        ...
        author1422 = new fifthelement.theelement.objects.Author(uuid39369, "");
        java.util.UUID uuid39370 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album482 = new fifthelement.theelement.objects.Album(uuid39370, "");
        song210 = new fifthelement.theelement.objects.Song(uuid39368, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1422, album482, "Pop", 10, 3.5);
        arraylist343.add(song210);
        arraylist343.iterator();
        song211.getAuthor();
        fifthelement.theelement.objects.Author author1424 = song211.getAuthor();
        author1424.getUUID();
        java.util.UUID uuid39372 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author1417 = new fifthelement.theelement.objects.Author(uuid39372, "Childish Gambino", 3);
        song211.setAuthor(author1417);
        song211.getAlbum();
        song208.getAuthor();
        song208.getAlbum();
        song209.getAuthor();
        ...
        author1416 = new fifthelement.theelement.objects.Author(uuid39374, "Coldplay", 10);
        song210.setAuthor(author1416);
        song210.getAlbum();
        ...
        author1418 = new fifthelement.theelement.objects.Author(uuid39377, "");
        album481 = new fifthelement.theelement.objects.Album(uuid39376, "A Head Full of Dreams", author1418, list72, 10);
        album481.getAuthor();
        fifthelement.theelement.objects.Author author1430 = album481.getAuthor();
        author1430.getUUID();
        java.util.UUID uuid39379 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1419 = new fifthelement.theelement.objects.Author(uuid39379, "Coldplay", 10);
        album481.setAuthor(author1419);
        song210.setAlbum(album481);
