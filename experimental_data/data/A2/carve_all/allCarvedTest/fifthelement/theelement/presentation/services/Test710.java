...
public class Test710 {
     ...
     * Method invocation under test: <fifthelement.theelement.presentation.services.NotificationService: void <init>()>_2268_4536
     */
    @Test(timeout = 4000)
    public void test_fifthelement_theelement_presentation_services_NotificationService_constructor_001() throws Exception {
        ...
        org.robolectric.android.controller.ServiceController servicecontroller166 = org.robolectric.Robolectric.buildService(fifthelement.theelement.presentation.services.NotificationService.class);
        servicecontroller166.get();
    }
}
