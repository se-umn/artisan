...
public class Test7895 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_008() throws Exception {
        ...
        author1779 = new fifthelement.theelement.objects.Author(uuid50896, "");
        song278 = new fifthelement.theelement.objects.Song(uuid50895, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1779, album597, "Hiphop", 3, 1.5);
        arraylist421.add(song278);
        java.util.UUID uuid50897 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song276 = new fifthelement.theelement.objects.Song(uuid50897, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1782, album597, "", 3, 4.5);
        arraylist421.add(song276);
        java.util.UUID uuid50898 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song275 = new fifthelement.theelement.objects.Song(uuid50898, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1782, album597, "Classical", 4, 2.0);
        ...
        author1781 = new fifthelement.theelement.objects.Author(uuid50900, "");
        java.util.UUID uuid50901 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album596 = new fifthelement.theelement.objects.Album(uuid50901, "");
        song277 = new fifthelement.theelement.objects.Song(uuid50899, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1781, album596, "Pop", 10, 3.5);
        arraylist421.add(song277);
        arraylist421.iterator();
        song278.getAuthor();
        fifthelement.theelement.objects.Author author1786 = song278.getAuthor();
        author1786.getUUID();
        java.util.UUID uuid50903 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author1783 = new fifthelement.theelement.objects.Author(uuid50903, "Childish Gambino", 3);
        song278.setAuthor(author1783);
        song278.getAlbum();
        song276.getAuthor();
        song276.getAlbum();
        song275.getAuthor();
        ...
        author1778 = new fifthelement.theelement.objects.Author(uuid50905, "Coldplay", 10);
        ...
        album598 = new fifthelement.theelement.objects.Album(uuid50907, "A Head Full of Dreams", author1780, list82, 10);
        album598.getAuthor();
        fifthelement.theelement.objects.Author author1792 = album598.getAuthor();
        author1792.getUUID();
        java.util.UUID uuid50910 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1784 = new fifthelement.theelement.objects.Author(uuid50910, "Coldplay", 10);
        album598.setAuthor(author1784);
        song277.setAlbum(album598);
        song276.compareTo(song278);
        song275.compareTo(song276);
        song277.compareTo(song275);
