...
public class Test404 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_constructor_002() throws Exception {
        ...
        song201 = new fifthelement.theelement.objects.Song(uuid38939, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1411, album478, "Hiphop", 3, 1.5);
        arraylist341.add(song201);
        java.util.UUID uuid38941 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song200 = new fifthelement.theelement.objects.Song(uuid38941, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1412, album478, "", 3, 4.5);
        arraylist341.add(song200);
        java.util.UUID uuid38942 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song203 = new fifthelement.theelement.objects.Song(uuid38942, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1412, album478, "Classical", 4, 2.0);
        ...
        song202 = new fifthelement.theelement.objects.Song(uuid38943, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1410, album477, "Pop", 10, 3.5);
