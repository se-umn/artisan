...
public class Test3879 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_001() throws Exception {
        ...
        author370 = new fifthelement.theelement.objects.Author(uuid5074, "");
        song85 = new fifthelement.theelement.objects.Song(uuid5073, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author370, album144, "Hiphop", 3, 1.5);
        arraylist28.add(song85);
        java.util.UUID uuid5075 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song86 = new fifthelement.theelement.objects.Song(uuid5075, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author368, album144, "", 3, 4.5);
        arraylist28.add(song86);
        java.util.UUID uuid5076 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song87 = new fifthelement.theelement.objects.Song(uuid5076, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author368, album144, "Classical", 4, 2.0);
        ...
        author369 = new fifthelement.theelement.objects.Author(uuid5078, "");
        java.util.UUID uuid5079 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album145 = new fifthelement.theelement.objects.Album(uuid5079, "");
        song88 = new fifthelement.theelement.objects.Song(uuid5077, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author369, album145, "Pop", 10, 3.5);
