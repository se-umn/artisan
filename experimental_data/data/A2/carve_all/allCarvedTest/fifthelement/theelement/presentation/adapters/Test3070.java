...
public class Test3070 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_constructor_001() throws Exception {
        ...
        author366 = new fifthelement.theelement.objects.Author(uuid5008, "");
        song81 = new fifthelement.theelement.objects.Song(uuid5007, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author366, album143, "Hiphop", 3, 1.5);
        arraylist27.add(song81);
        java.util.UUID uuid5009 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song82 = new fifthelement.theelement.objects.Song(uuid5009, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author365, album143, "", 3, 4.5);
        arraylist27.add(song82);
        java.util.UUID uuid5010 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song83 = new fifthelement.theelement.objects.Song(uuid5010, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author365, album143, "Classical", 4, 2.0);
        ...
        author367 = new fifthelement.theelement.objects.Author(uuid5012, "");
        java.util.UUID uuid5013 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album142 = new fifthelement.theelement.objects.Album(uuid5013, "");
        song84 = new fifthelement.theelement.objects.Song(uuid5011, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author367, album142, "Pop", 10, 3.5);
