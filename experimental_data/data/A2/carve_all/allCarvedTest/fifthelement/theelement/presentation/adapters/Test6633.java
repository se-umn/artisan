...
public class Test6633 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_005() throws Exception {
        ...
        author808 = new fifthelement.theelement.objects.Author(uuid14263, "");
        song183 = new fifthelement.theelement.objects.Song(uuid14262, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author808, album301, "Hiphop", 3, 1.5);
        arraylist75.add(song183);
        java.util.UUID uuid14264 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song180 = new fifthelement.theelement.objects.Song(uuid14264, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author809, album301, "", 3, 4.5);
        arraylist75.add(song180);
        java.util.UUID uuid14265 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song182 = new fifthelement.theelement.objects.Song(uuid14265, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author809, album301, "Classical", 4, 2.0);
        ...
        author810 = new fifthelement.theelement.objects.Author(uuid14267, "");
        ...
        song181 = new fifthelement.theelement.objects.Song(uuid14266, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author810, album300, "Pop", 10, 3.5);
