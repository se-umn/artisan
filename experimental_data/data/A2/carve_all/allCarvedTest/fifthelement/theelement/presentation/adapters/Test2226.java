...
public class Test2226 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_008() throws Exception {
        ...
        song277 = new fifthelement.theelement.objects.Song(uuid50895, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author1782, album597, "Hiphop", 3, 1.5);
        arraylist421.add(song277);
        java.util.UUID uuid50897 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song276 = new fifthelement.theelement.objects.Song(uuid50897, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author1784, album597, "", 3, 4.5);
        arraylist421.add(song276);
        java.util.UUID uuid50898 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song278 = new fifthelement.theelement.objects.Song(uuid50898, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author1784, album597, "Classical", 4, 2.0);
        ...
        album598 = new fifthelement.theelement.objects.Album(uuid50901, "");
        song275 = new fifthelement.theelement.objects.Song(uuid50899, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author1779, album598, "Pop", 10, 3.5);
        ...
        author1778 = new fifthelement.theelement.objects.Author(uuid50903, "Childish Gambino", 3);
        song277.setAuthor(author1778);
        song277.getAlbum();
        song276.getAuthor();
        song276.getAlbum();
        song278.getAuthor();
        song278.getAlbum();
        song275.getAuthor();
        fifthelement.theelement.objects.Author author1790 = song275.getAuthor();
        author1790.getUUID();
        java.util.UUID uuid50905 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author1783 = new fifthelement.theelement.objects.Author(uuid50905, "Coldplay", 10);
        song275.setAuthor(author1783);
        song275.getAlbum();
        fifthelement.theelement.objects.Album album603 = song275.getAlbum();
        album603.getUUID();
        ...
        author1780 = new fifthelement.theelement.objects.Author(uuid50908, "");
        album596 = new fifthelement.theelement.objects.Album(uuid50907, "A Head Full of Dreams", author1780, list82, 10);
        album596.getAuthor();
        ...
        author1781 = new fifthelement.theelement.objects.Author(uuid50910, "Coldplay", 10);
        album596.setAuthor(author1781);
        song275.setAlbum(album596);
        song276.compareTo(song277);
        song278.compareTo(song276);
