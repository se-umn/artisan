...
public class Test589 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_setShuffleEnabled_001() throws Exception {
        ...
        author447 = new fifthelement.theelement.objects.Author(uuid3618, "");
        song469 = new fifthelement.theelement.objects.Song(uuid3617, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author447, album227, "Hiphop", 3, 1.5);
        arraylist166.add(song469);
        java.util.UUID uuid3619 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song471 = new fifthelement.theelement.objects.Song(uuid3619, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author458, album227, "", 3, 4.5);
        arraylist166.add(song471);
        java.util.UUID uuid3620 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song463 = new fifthelement.theelement.objects.Song(uuid3620, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author458, album227, "Classical", 4, 2.0);
        ...
        author445 = new fifthelement.theelement.objects.Author(uuid3622, "");
        java.util.UUID uuid3623 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album225 = new fifthelement.theelement.objects.Album(uuid3623, "");
        song473 = new fifthelement.theelement.objects.Song(uuid3621, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author445, album225, "Pop", 10, 3.5);
        arraylist166.add(song473);
        ...
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        songlistservice5.setCurrentSongsList(arraylist166);
        ...
        author449 = new fifthelement.theelement.objects.Author(uuid3689, "");
        song460 = new fifthelement.theelement.objects.Song(uuid3688, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author449, album227, "Hiphop", 3, 1.5);
        arraylist165.add(song460);
        java.util.UUID uuid3690 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song462 = new fifthelement.theelement.objects.Song(uuid3690, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author458, album227, "", 3, 4.5);
        arraylist165.add(song462);
        java.util.UUID uuid3691 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song464 = new fifthelement.theelement.objects.Song(uuid3691, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author458, album227, "Classical", 4, 2.0);
        ...
        author462 = new fifthelement.theelement.objects.Author(uuid3693, "");
        java.util.UUID uuid3694 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album221 = new fifthelement.theelement.objects.Album(uuid3694, "");
        song466 = new fifthelement.theelement.objects.Song(uuid3692, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author462, album221, "Pop", 10, 3.5);
        arraylist165.add(song466);
        arraylist165.iterator();
        song460.getAuthor();
        fifthelement.theelement.objects.Author author467 = song460.getAuthor();
        author467.getUUID();
        java.util.UUID uuid3696 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author461 = new fifthelement.theelement.objects.Author(uuid3696, "Childish Gambino", 3);
        song460.setAuthor(author461);
        song460.getAlbum();
        song462.getAuthor();
        song462.getAlbum();
        fifthelement.theelement.objects.Author author469 = song464.getAuthor();
        fifthelement.theelement.objects.Album album231 = song464.getAlbum();
        song466.getAuthor();
        fifthelement.theelement.objects.Author author471 = song466.getAuthor();
        author471.getUUID();
        java.util.UUID uuid3698 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author464 = new fifthelement.theelement.objects.Author(uuid3698, "Coldplay", 10);
        song466.setAuthor(author464);
        song466.getAlbum();
        fifthelement.theelement.objects.Album album233 = song466.getAlbum();
        album233.getUUID();
        ...
        author460 = new fifthelement.theelement.objects.Author(uuid3701, "");
        album223 = new fifthelement.theelement.objects.Album(uuid3700, "A Head Full of Dreams", author460, list18, 10);
        album223.getAuthor();
        ...
        author456 = new fifthelement.theelement.objects.Author(uuid3703, "Coldplay", 10);
        album223.setAuthor(author456);
        song466.setAlbum(album223);
        songlistservice5.sortSongs(arraylist165);
        arraylist165.size();
        arraylist165.size();
        ...
        author454 = new fifthelement.theelement.objects.Author(uuid3718, "");
        song458 = new fifthelement.theelement.objects.Song(uuid3717, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author454, album231, "Hiphop", 3, 1.5);
        arraylist164.add(song458);
        java.util.UUID uuid3719 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song470 = new fifthelement.theelement.objects.Song(uuid3719, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author469, album231, "", 3, 4.5);
        arraylist164.add(song470);
        java.util.UUID uuid3720 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song467 = new fifthelement.theelement.objects.Song(uuid3720, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author469, album231, "Classical", 4, 2.0);
        ...
        author448 = new fifthelement.theelement.objects.Author(uuid3722, "");
        java.util.UUID uuid3723 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album224 = new fifthelement.theelement.objects.Album(uuid3723, "");
        song468 = new fifthelement.theelement.objects.Song(uuid3721, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author448, album224, "Pop", 10, 3.5);
        arraylist164.add(song468);
        arraylist164.iterator();
        song458.getAuthor();
        fifthelement.theelement.objects.Author author475 = song458.getAuthor();
        author475.getUUID();
        java.util.UUID uuid3725 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author450 = new fifthelement.theelement.objects.Author(uuid3725, "Childish Gambino", 3);
        song458.setAuthor(author450);
        song458.getAlbum();
        song470.getAuthor();
        song470.getAlbum();
        song467.getAuthor();
        fifthelement.theelement.objects.Album album236 = song467.getAlbum();
        song468.getAuthor();
        ...
        author451 = new fifthelement.theelement.objects.Author(uuid3727, "Coldplay", 10);
        song468.setAuthor(author451);
        song468.getAlbum();
        ...
        author452 = new fifthelement.theelement.objects.Author(uuid3730, "");
        album222 = new fifthelement.theelement.objects.Album(uuid3729, "A Head Full of Dreams", author452, list18, 10);
        album222.getAuthor();
        fifthelement.theelement.objects.Author author481 = album222.getAuthor();
        author481.getUUID();
        java.util.UUID uuid3732 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author446 = new fifthelement.theelement.objects.Author(uuid3732, "Coldplay", 10);
        album222.setAuthor(author446);
        song468.setAlbum(album222);
        songlistservice5.sortSongs(arraylist164);
        arraylist164.size();
        arraylist164.size();
        arraylist164.size();
        arraylist164.size();
        fifthelement.theelement.objects.Song song474 = (fifthelement.theelement.objects.Song) arraylist164.get(0);
        fifthelement.theelement.objects.Author author482 = song474.getAuthor();
        author482.getName();
        song474.getName();
        fifthelement.theelement.objects.Song song475 = (fifthelement.theelement.objects.Song) arraylist164.get(1);
        song475.getAuthor();
        song475.getName();
        fifthelement.theelement.objects.Song song476 = (fifthelement.theelement.objects.Song) arraylist164.get(2);
        song476.getAuthor();
        song476.getName();
        fifthelement.theelement.objects.Song song477 = (fifthelement.theelement.objects.Song) arraylist164.get(3);
        fifthelement.theelement.objects.Author author485 = song477.getAuthor();
        author485.getName();
        song477.getName();
        arraylist164.size();
        arraylist164.size();
        fifthelement.theelement.objects.Song song478 = (fifthelement.theelement.objects.Song) arraylist164.get(0);
        fifthelement.theelement.objects.Author author486 = song478.getAuthor();
        author486.getName();
        song478.getName();
        fifthelement.theelement.objects.Song song479 = (fifthelement.theelement.objects.Song) arraylist164.get(1);
        song479.getAuthor();
        song479.getName();
        fifthelement.theelement.objects.Song song480 = (fifthelement.theelement.objects.Song) arraylist164.get(2);
        song480.getAuthor();
        song480.getName();
        fifthelement.theelement.objects.Song song481 = (fifthelement.theelement.objects.Song) arraylist164.get(3);
        fifthelement.theelement.objects.Author author489 = song481.getAuthor();
        author489.getName();
        song481.getName();
        arraylist164.size();
        fifthelement.theelement.objects.Song song482 = (fifthelement.theelement.objects.Song) arraylist164.get(0);
        fifthelement.theelement.objects.Author author490 = song482.getAuthor();
        author490.getName();
        song482.getName();
        fifthelement.theelement.objects.Song song483 = (fifthelement.theelement.objects.Song) arraylist164.get(1);
        song483.getAuthor();
        song483.getName();
        fifthelement.theelement.objects.Song song484 = (fifthelement.theelement.objects.Song) arraylist164.get(2);
        song484.getAuthor();
        song484.getName();
        fifthelement.theelement.objects.Song song485 = (fifthelement.theelement.objects.Song) arraylist164.get(3);
        fifthelement.theelement.objects.Author author493 = song485.getAuthor();
        author493.getName();
        song485.getName();
        arraylist164.size();
        arraylist164.size();
        fifthelement.theelement.objects.Song song486 = (fifthelement.theelement.objects.Song) arraylist164.get(0);
        fifthelement.theelement.objects.Author author494 = song486.getAuthor();
        author494.getName();
        song486.getName();
        fifthelement.theelement.objects.Song song487 = (fifthelement.theelement.objects.Song) arraylist164.get(1);
        song487.getAuthor();
        song487.getName();
        fifthelement.theelement.objects.Song song488 = (fifthelement.theelement.objects.Song) arraylist164.get(2);
        song488.getAuthor();
        song488.getName();
        fifthelement.theelement.objects.Song song489 = (fifthelement.theelement.objects.Song) arraylist164.get(3);
        fifthelement.theelement.objects.Author author497 = song489.getAuthor();
        author497.getName();
        song489.getName();
        arraylist164.size();
        arraylist164.size();
        fifthelement.theelement.objects.Song song490 = (fifthelement.theelement.objects.Song) arraylist164.get(0);
        fifthelement.theelement.objects.Author author498 = song490.getAuthor();
        author498.getName();
        song490.getName();
        fifthelement.theelement.objects.Song song491 = (fifthelement.theelement.objects.Song) arraylist164.get(1);
        song491.getAuthor();
        song491.getName();
        fifthelement.theelement.objects.Song song492 = (fifthelement.theelement.objects.Song) arraylist164.get(2);
        song492.getAuthor();
        song492.getName();
        fifthelement.theelement.objects.Song song493 = (fifthelement.theelement.objects.Song) arraylist164.get(3);
        ...
        arraylist164.size();
        arraylist164.size();
        fifthelement.theelement.objects.Song song498 = (fifthelement.theelement.objects.Song) arraylist164.get(0);
        fifthelement.theelement.objects.Author author502 = song498.getAuthor();
        author502.getName();
        song498.getName();
        fifthelement.theelement.objects.Song song499 = (fifthelement.theelement.objects.Song) arraylist164.get(1);
        song499.getAuthor();
        song499.getName();
        fifthelement.theelement.objects.Song song500 = (fifthelement.theelement.objects.Song) arraylist164.get(2);
        song500.getAuthor();
        song500.getName();
        fifthelement.theelement.objects.Song song501 = (fifthelement.theelement.objects.Song) arraylist164.get(3);
        fifthelement.theelement.objects.Author author505 = song501.getAuthor();
        author505.getName();
        song501.getName();
        arraylist164.size();
        arraylist164.size();
        fifthelement.theelement.objects.Song song502 = (fifthelement.theelement.objects.Song) arraylist164.get(0);
        fifthelement.theelement.objects.Author author506 = song502.getAuthor();
        author506.getName();
        song502.getName();
        fifthelement.theelement.objects.Song song503 = (fifthelement.theelement.objects.Song) arraylist164.get(1);
        song503.getAuthor();
        song503.getName();
        fifthelement.theelement.objects.Song song504 = (fifthelement.theelement.objects.Song) arraylist164.get(2);
        fifthelement.theelement.objects.Author author508 = song504.getAuthor();
        song504.getName();
        fifthelement.theelement.objects.Song song505 = (fifthelement.theelement.objects.Song) arraylist164.get(3);
        ...
        author453 = new fifthelement.theelement.objects.Author(uuid3734, "");
        song465 = new fifthelement.theelement.objects.Song(uuid3733, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author453, album236, "Hiphop", 3, 1.5);
        arraylist163.add(song465);
        java.util.UUID uuid3735 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song461 = new fifthelement.theelement.objects.Song(uuid3735, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author508, album236, "", 3, 4.5);
        arraylist163.add(song461);
        java.util.UUID uuid3736 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song459 = new fifthelement.theelement.objects.Song(uuid3736, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author508, album236, "Classical", 4, 2.0);
        ...
        author465 = new fifthelement.theelement.objects.Author(uuid3738, "");
        ...
        song472 = new fifthelement.theelement.objects.Song(uuid3737, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author465, album226, "Pop", 10, 3.5);
        arraylist163.add(song472);
        arraylist163.iterator();
        song465.getAuthor();
        fifthelement.theelement.objects.Author author511 = song465.getAuthor();
        author511.getUUID();
        java.util.UUID uuid3741 = java.util.UUID.fromString("e9bcb1b6-7b3b-11e8-adc0-fa7ae01bbebc");
        author459 = new fifthelement.theelement.objects.Author(uuid3741, "Childish Gambino", 3);
        song465.setAuthor(author459);
        song465.getAlbum();
        song461.getAuthor();
        song461.getAlbum();
        song459.getAuthor();
        song459.getAlbum();
        song472.getAuthor();
        fifthelement.theelement.objects.Author author515 = song472.getAuthor();
        author515.getUUID();
        java.util.UUID uuid3743 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author463 = new fifthelement.theelement.objects.Author(uuid3743, "Coldplay", 10);
        song472.setAuthor(author463);
        song472.getAlbum();
        fifthelement.theelement.objects.Album album243 = song472.getAlbum();
        album243.getUUID();
        ...
        author455 = new fifthelement.theelement.objects.Author(uuid3746, "");
        album228 = new fifthelement.theelement.objects.Album(uuid3745, "A Head Full of Dreams", author455, list18, 10);
        album228.getAuthor();
        ...
        author457 = new fifthelement.theelement.objects.Author(uuid3748, "Coldplay", 10);
        album228.setAuthor(author457);
        song472.setAlbum(album228);
