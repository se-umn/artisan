...
public class Test675 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_sortSongs_001() throws Exception {
        ...
        author81 = new fifthelement.theelement.objects.Author(uuid1359, "");
        song17 = new fifthelement.theelement.objects.Song(uuid1358, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author81, album40, "Hiphop", 3, 1.5);
        arraylist42.add(song17);
        java.util.UUID uuid1360 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song18 = new fifthelement.theelement.objects.Song(uuid1360, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author83, album40, "", 3, 4.5);
        arraylist42.add(song18);
        java.util.UUID uuid1361 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song22 = new fifthelement.theelement.objects.Song(uuid1361, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author83, album40, "Classical", 4, 2.0);
        ...
        author80 = new fifthelement.theelement.objects.Author(uuid1363, "");
        ...
        song16 = new fifthelement.theelement.objects.Song(uuid1362, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author80, album39, "Pop", 10, 3.5);
        ...
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        songlistservice2.setCurrentSongsList(arraylist42);
        ...
        author82 = new fifthelement.theelement.objects.Author(uuid1430, "");
        song21 = new fifthelement.theelement.objects.Song(uuid1429, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author82, album40, "Hiphop", 3, 1.5);
        arraylist43.add(song21);
        java.util.UUID uuid1431 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song20 = new fifthelement.theelement.objects.Song(uuid1431, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author83, album40, "", 3, 4.5);
        arraylist43.add(song20);
        java.util.UUID uuid1432 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song15 = new fifthelement.theelement.objects.Song(uuid1432, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author83, album40, "Classical", 4, 2.0);
        arraylist43.add(song15);
        ...
        album41 = new fifthelement.theelement.objects.Album(uuid1435, "");
        song19 = new fifthelement.theelement.objects.Song(uuid1433, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author79, album41, "Pop", 10, 3.5);
        arraylist43.add(song19);
        arraylist43.iterator();
        songlistservice2.sortSongs(arraylist43);
    }
}
