...
public class Test758 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_getAutoplayEnabled_001() throws Exception {
        ...
        author61 = new fifthelement.theelement.objects.Author(uuid573, "");
        song30 = new fifthelement.theelement.objects.Song(uuid572, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author61, album31, "Hiphop", 3, 1.5);
        arraylist9.add(song30);
        java.util.UUID uuid574 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song34 = new fifthelement.theelement.objects.Song(uuid574, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author60, album31, "", 3, 4.5);
        arraylist9.add(song34);
        java.util.UUID uuid575 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song33 = new fifthelement.theelement.objects.Song(uuid575, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author60, album31, "Classical", 4, 2.0);
        ...
        author64 = new fifthelement.theelement.objects.Author(uuid585, "");
        song28 = new fifthelement.theelement.objects.Song(uuid584, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author64, album31, "Hiphop", 3, 1.5);
        arraylist10.add(song28);
        java.util.UUID uuid586 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song29 = new fifthelement.theelement.objects.Song(uuid586, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author60, album31, "", 3, 4.5);
        arraylist10.add(song29);
        java.util.UUID uuid587 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song31 = new fifthelement.theelement.objects.Song(uuid587, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author60, album31, "Classical", 4, 2.0);
        arraylist10.add(song31);
        ...
        author62 = new fifthelement.theelement.objects.Author(uuid589, "");
        java.util.UUID uuid590 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album33 = new fifthelement.theelement.objects.Album(uuid590, "");
        song32 = new fifthelement.theelement.objects.Song(uuid588, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author62, album33, "Pop", 10, 3.5);
        arraylist10.add(song32);
        ...
        author63 = new fifthelement.theelement.objects.Author(uuid592, "Childish Gambino", 3);
        song28.setAuthor(author63);
        song28.getAlbum();
        song29.getAuthor();
        song29.getAlbum();
        song31.getAuthor();
        song31.getAlbum();
        song32.getAuthor();
        fifthelement.theelement.objects.Author author70 = song32.getAuthor();
        author70.getUUID();
        java.util.UUID uuid594 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author59 = new fifthelement.theelement.objects.Author(uuid594, "Coldplay", 10);
        song32.setAuthor(author59);
        song32.getAlbum();
        fifthelement.theelement.objects.Album album38 = song32.getAlbum();
        album38.getUUID();
        ...
        author57 = new fifthelement.theelement.objects.Author(uuid597, "");
        album32 = new fifthelement.theelement.objects.Album(uuid596, "A Head Full of Dreams", author57, list4, 10);
        album32.getAuthor();
        fifthelement.theelement.objects.Author author72 = album32.getAuthor();
        author72.getUUID();
        java.util.UUID uuid599 = java.util.UUID.fromString("359f9962-7a89-11e8-adc0-fa7ae01bbebc");
        author56 = new fifthelement.theelement.objects.Author(uuid599, "Coldplay", 10);
        album32.setAuthor(author56);
        song32.setAlbum(album32);
