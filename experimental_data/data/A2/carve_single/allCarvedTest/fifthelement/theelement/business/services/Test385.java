...
public class Test385 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_setCurrentSongsList_001() throws Exception {
        ...
        song6 = new fifthelement.theelement.objects.Song(uuid229, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author34, album16, "Hiphop", 3, 1.5);
        arraylist4.add(song6);
        java.util.UUID uuid231 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song5 = new fifthelement.theelement.objects.Song(uuid231, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author32, album16, "", 3, 4.5);
        arraylist4.add(song5);
        java.util.UUID uuid232 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song8 = new fifthelement.theelement.objects.Song(uuid232, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author32, album16, "Classical", 4, 2.0);
        ...
        author33 = new fifthelement.theelement.objects.Author(uuid234, "");
        java.util.UUID uuid235 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album17 = new fifthelement.theelement.objects.Album(uuid235, "");
        song7 = new fifthelement.theelement.objects.Song(uuid233, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author33, album17, "Pop", 10, 3.5);
