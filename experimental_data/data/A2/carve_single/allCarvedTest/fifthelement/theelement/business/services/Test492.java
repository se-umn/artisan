...
public class Test492 {
    ...
    public void test_fifthelement_theelement_business_services_SongListService_sortSongs_001() throws Exception {
        ...
        author36 = new fifthelement.theelement.objects.Author(uuid256, "");
        song11 = new fifthelement.theelement.objects.Song(uuid255, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author36, album19, "Hiphop", 3, 1.5);
        arraylist5.add(song11);
        java.util.UUID uuid257 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song15 = new fifthelement.theelement.objects.Song(uuid257, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author35, album19, "", 3, 4.5);
        arraylist5.add(song15);
        java.util.UUID uuid258 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song14 = new fifthelement.theelement.objects.Song(uuid258, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author35, album19, "Classical", 4, 2.0);
        arraylist5.add(song14);
        ...
        author38 = new fifthelement.theelement.objects.Author(uuid268, "");
        song9 = new fifthelement.theelement.objects.Song(uuid267, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author38, album19, "Hiphop", 3, 1.5);
        arraylist6.add(song9);
        java.util.UUID uuid269 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song10 = new fifthelement.theelement.objects.Song(uuid269, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author35, album19, "", 3, 4.5);
        arraylist6.add(song10);
        java.util.UUID uuid270 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song12 = new fifthelement.theelement.objects.Song(uuid270, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author35, album19, "Classical", 4, 2.0);
        arraylist6.add(song12);
        ...
        author37 = new fifthelement.theelement.objects.Author(uuid272, "");
        java.util.UUID uuid273 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album20 = new fifthelement.theelement.objects.Album(uuid273, "");
        song13 = new fifthelement.theelement.objects.Song(uuid271, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author37, album20, "Pop", 10, 3.5);
        arraylist6.add(song13);
        arraylist6.iterator();
