...
public class Test1170 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_getCount_001() throws Exception {
        ...
        author54 = new fifthelement.theelement.objects.Author(uuid542, "");
        song24 = new fifthelement.theelement.objects.Song(uuid541, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author54, album29, "Hiphop", 3, 1.5);
        arraylist8.add(song24);
        java.util.UUID uuid543 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song25 = new fifthelement.theelement.objects.Song(uuid543, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author53, album29, "", 3, 4.5);
        arraylist8.add(song25);
        java.util.UUID uuid544 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song26 = new fifthelement.theelement.objects.Song(uuid544, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author53, album29, "Classical", 4, 2.0);
        ...
        author55 = new fifthelement.theelement.objects.Author(uuid546, "");
        java.util.UUID uuid547 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album28 = new fifthelement.theelement.objects.Album(uuid547, "");
        song27 = new fifthelement.theelement.objects.Song(uuid545, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author55, album28, "Pop", 10, 3.5);
