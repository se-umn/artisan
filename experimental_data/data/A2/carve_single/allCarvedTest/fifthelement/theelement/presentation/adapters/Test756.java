...
public class Test756 {
    ...
    public void test_fifthelement_theelement_presentation_adapters_SongsListAdapter_constructor_001() throws Exception {
        ...
        author52 = new fifthelement.theelement.objects.Author(uuid476, "");
        song20 = new fifthelement.theelement.objects.Song(uuid475, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author52, album26, "Hiphop", 3, 1.5);
        arraylist7.add(song20);
        java.util.UUID uuid477 = java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        song21 = new fifthelement.theelement.objects.Song(uuid477, "Hall of Fame", "android.resource://fifthelement.theelement/raw/hall_of_fame", author50, album26, "", 3, 4.5);
        arraylist7.add(song21);
        java.util.UUID uuid478 = java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        song22 = new fifthelement.theelement.objects.Song(uuid478, "Classical Music", "android.resource://fifthelement.theelement/raw/classical_music", author50, album26, "Classical", 4, 2.0);
        ...
        author51 = new fifthelement.theelement.objects.Author(uuid480, "");
        java.util.UUID uuid481 = java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        album27 = new fifthelement.theelement.objects.Album(uuid481, "");
        song23 = new fifthelement.theelement.objects.Song(uuid479, "Adventure of a Lifetime", "android.resource://fifthelement.theelement/raw/coldplay_adventure_of_a_lifetime", author51, album27, "Pop", 10, 3.5);
