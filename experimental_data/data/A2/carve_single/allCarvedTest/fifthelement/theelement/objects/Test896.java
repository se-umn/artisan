...
public class Test896 {
    ...
    public void test_fifthelement_theelement_objects_Song_setAuthor_001() throws Exception {
        ...
        author9 = new fifthelement.theelement.objects.Author(uuid63, "");
        song2 = new fifthelement.theelement.objects.Song(uuid62, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author9, album3, "Hiphop", 3, 1.5);
        ...
        author10 = new fifthelement.theelement.objects.Author(uuid71, "Childish Gambino", 3);
        song2.setAuthor(author10);
    }
}
