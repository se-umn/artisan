...
public class Test733 {
    ...
    public void test_fifthelement_theelement_objects_Song_getAlbum_001() throws Exception {
        ...
        author14 = new fifthelement.theelement.objects.Author(uuid82, "");
        song3 = new fifthelement.theelement.objects.Song(uuid81, "This Is America", "android.resource://fifthelement.theelement/raw/childish_gambino_this_is_america", author14, album4, "Hiphop", 3, 1.5);
        ...
        author13 = new fifthelement.theelement.objects.Author(uuid90, "Childish Gambino", 3);
        song3.setAuthor(author13);
        song3.getAlbum();
    }
}
