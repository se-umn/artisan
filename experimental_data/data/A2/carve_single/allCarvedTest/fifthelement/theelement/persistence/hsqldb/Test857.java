...
public class Test857 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_AuthorPersistenceHSQLDB_updateAuthor_001() throws Exception {
        ...
        fifthelement.theelement.objects.Author author536 = null;
        ...
        author528 = new fifthelement.theelement.objects.Author(uuid2634, "");
        java.util.UUID uuid2635 = author528.getUUID();
        ...
        author515 = new fifthelement.theelement.objects.Author(uuid2641, "");
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        authorpersistencehsqldb2.getAuthorByUUID(uuid2637);
        java.util.UUID uuid2644 = author515.getUUID();
        ...
        author525 = new fifthelement.theelement.objects.Author(uuid2648, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid2655 = author525.getUUID();
        ...
        author536 = new fifthelement.theelement.objects.Author(uuid2659, "");
        java.util.UUID.fromString("123e4567-e89b-12d3-a456-556642440000");
        java.util.UUID.fromString("54947df8-0e9e-4471-a2f9-9af509fb5889");
        java.util.UUID.fromString("7dc53df5-703e-49b3-8670-b1c468f47f1f");
        ...
        java.util.UUID.fromString("c8fe0546-7a88-11e8-adc0-fa7ae01bbebc");
        java.util.UUID.randomUUID();
        java.util.UUID uuid2666 = author536.getUUID();
