...
public class Test866 {
    ...
    public void test_fifthelement_theelement_persistence_hsqldb_SongPersistenceHSQLDB_updateSong_001() throws Exception {
        ...
        fifthelement.theelement.objects.Author author564 = null;
        ...
        author564 = new fifthelement.theelement.objects.Author(uuid3955, "");
        album269 = new fifthelement.theelement.objects.Album(uuid3954, "A Head Full of Dreams", author564, list20, 10);
        song520.setAlbum(album269);
        song520.getAuthor();
        ...
        author565 = new fifthelement.theelement.objects.Author(uuid3957, "Coldplay", 10);
        song520.setAuthor(author565);
