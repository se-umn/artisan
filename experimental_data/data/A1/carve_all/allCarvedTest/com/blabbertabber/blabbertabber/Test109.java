...
public class Test109 {
     ...
     * Method invocation under test: <com.blabbertabber.blabbertabber.Timer: long time()>_294_588
     */
    @Test(timeout = 4000)
    public void test_com_blabbertabber_blabbertabber_Timer_time_026() throws Exception {
        com.blabbertabber.blabbertabber.Timer timer37 = null;
        timer37 = new com.blabbertabber.blabbertabber.Timer(1200L);
        timer37.time();
        timer37.start();
        timer37.time();
    }
