...
public class TestHotelUpdateReservationRoom {// extends AbstractHotelSystemTest
												// {
	...
	public void systemTest() {
		...
		commands.add("1"); // Select 1 room -> 0 To go back !
		commands.add("2"); // 2. Upgrade the room
		commands.add("1"); // 1. Happy Queen
		//
