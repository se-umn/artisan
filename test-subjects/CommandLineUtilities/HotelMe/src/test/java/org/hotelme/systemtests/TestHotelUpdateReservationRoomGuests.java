...
public class TestHotelUpdateReservationRoomGuests {// extends AbstractHotelSystemTest
												// {
	...
	public void systemTest() {
		...
		commands.add("1"); // Select 1 room 
		commands.add("1"); // 1. Guests
		commands.add("3"); // 3 guests
		commands.add("1"); // 1 child
		//
