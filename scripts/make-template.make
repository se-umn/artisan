...
{%- for class in make_instr_skip_classes %}
{{class}}
{%- endfor %}

{%- for package in make_instr_filter_packages %}
{{package}}
{%- endfor %}

{%- for class in make_instr_filter_classes %}
{{class}}
{%- endfor %}
"
...
CARVING_OPTIONS=" \
{%- for method in make_carving_filter_methods %}
{{method}}
{%- endfor %}
"
