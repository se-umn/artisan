...
public class JimpleUtils {
  ...
  public static boolean isPrimitive(String type) {
    return type.equals("boolean") || type.equals("byte") || type.equals("char") || type
        .equals("short")
        || type.equals("int") || type.equals("long") || type.equals("float") || type
        .equals("double");
  }
  ...
  /**
   * We adopt a naive approach and LITERALLY compare methods, this might not work in general but
   * should be good enough. Note that for the test Method we forcefully insert the
   * body.insertIdentityStmtsz
   *
   * @param testClass
   * @param testMethod
   * @return
  ...
  public static String getSubSignature(String jimpleMethod) {
    ...
    return sb.append(jimpleMethod.split(" ")[1] + " " + jimpleMethod.split(" ")[2])
  ...
  private final static List<String> boxedPrimitiveTypes = Arrays
      .asList(Byte.class.getName(), Short.class.getName(), Integer.class.getName(),
  ...
  private static final List<String> interestingAndroidLifecycleCallbacks = Arrays.asList(
      "onAttach", "onCreate", "onDestroy", "onPause", "onPostCreate", "onPostResume", "onRestart",
      "onRestoreInstanceState", "onResume", "onSaveInstanceState", "onStart", "onStop",
      "onUserLeaving"//
  ...
  private static final List<String> interestingFragmentLifecycleCallbacks = Arrays
      .asList("onActivityCreated", "onActivityResult", "onAttach", "onAttachFragment",
          "onConfigurationChanged", "onCreate", "onCreateContextMenu", "onCreateOptionsMenu",
          "onDestroy",
          "onDestroyOptionsMenu", "onDestroyView", "onDetach", "onHiddenChanged", "onInflate",
          "onLowMemory",
          "onMultiWindowModeChanged", "onOptionsMenuClosed", "onPause",
          "onPictureInPictureModeChanged",
          "onPrepareOptionsMenu", "onRequestPermissionsResult", "onResume", "onSaveInstanceState",
          "onStart",
          "onStop", "onViewCreated", "onViewStateRestored");

  private static final List<String> androidPackagePrefixes = Arrays
      .asList("android.", "com.google.android.", "androidx.");
  ...
  public static boolean isAndroidMethod(String methodSignature) {
    ...
    return androidPackagePrefixes.stream().map(classSignature::startsWith)
