...
public class AndroidEntryPointConstants {
	...
	public static boolean isLifecycleMethod(String methodName) {
		return getActivityLifecycleMethods().contains(methodName)
				|| getApplicationLifecycleMethods().contains(methodName)
				|| getBroadcastLifecycleMethods().contains(methodName)
				|| getContentproviderLifecycleMethods().contains(methodName)
				|| getGCMIntentServiceMethods().contains(methodName)
