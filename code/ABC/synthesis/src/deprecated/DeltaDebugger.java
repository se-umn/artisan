...
public class DeltaDebugger {
	...
	public DeltaDebugger(File outputDir, Set<CompilationUnit> augmentedTestClasses, //
			String resetEnvironmentBy, //
			List<File> projectJars, List<String> additionalProperties) throws IOException {
	...
	public static void minimize(File testSourceFolder,
		...
		List<Unit> validation = Utils.generateValidationUnit(testMethod, mut.getXmlDumpForOwner(),
				mut.getXmlDumpForReturn(), null);
