 ...
 * <p>
 * Challenge 2: how to deal/handle objects provided by the runtime framework "external": carving or
 * mocking, maybe tainting ?
 *
 * @author gambi
 */
public class AndroidActivityCarver_OLD implements MethodCarver {
  ...
  @Override
  public List<CarvedExecution> carve(MethodInvocation methodInvocation)
...
//		return carvedExecutions;
   ...
   *
   * @param orderedMethodsInvocationsToCarve
   * @return
...
//		return carvedTests;
  ...
  /**
   * Carving is a recursive activity -> carving methods and carving "data". This is the base call.
   * <p>
   * In theory carving might produce several different setup, we force this to return one of them.
   * <p>
   * TODO If the cache is reinitialized everytime that might not be smart .... Also consider to
   * store the cache somewhere on the disk !!
   *
