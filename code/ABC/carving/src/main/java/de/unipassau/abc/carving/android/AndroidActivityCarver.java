...
//		return carvingResult;
	...
	public List<Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph>> carveActivity(
			ObjectInstance activityUnderTest, List<MethodInvocation> activityMethods) throws CarvingException {
		/*
	...
	private void carveDirectDataDependencies(MethodInvocation methodInvocationUnderTest,
			Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph> carvedTest) throws CarvingException {
		logger.info("\n\n====================================================\n" //
	...
	/**
	 * Remove any duplicated method invocation and in general invocations that are
	 * not needed while creating Robolectric's tests.
	 * 
	 * Summarize carved method invocations: If an invocation is subsumed by another
	 * invocation, we can remove it.
	 * 
	 * This include methods automatically triggered by the framework, such as
	 * Fragment Lifecycle events triggered after Activity Lifecycle events.
	 */
	private void summarize(ObjectInstance activityUnderTest,
		...
		for (MethodInvocation carvedMethodInvocation : efGraph.getOrderedMethodInvocations()) {
			...
			if (fragmentLifeCycle.isPresent()) {
				logger.debug("Method invocation " + carvedMethodInvocation + " is subsumed by Fragment lifecycle event "
