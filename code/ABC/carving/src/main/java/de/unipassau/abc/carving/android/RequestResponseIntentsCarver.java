...
public class RequestResponseIntentsCarver {
	...
	public List<Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph>> carve(ObjectInstance activityUnderTest,
		...
		Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph> carvedActivityMethods = activityMethodsCarver
		...
		List<Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph>> carvedIntents = new ArrayList<>();
		...
		for (MethodInvocation onPauseMethodInvocation : onResumeAndOnPauseMethodInvocations) {
			...
			//
			Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph> carvedIntentsForOnPause = new Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph>(
					efGraph, ddGraph,
					// TODO
					new CallGraphImpl());
			//
			...
			StartingIntentCarver intentCarver = new StartingIntentCarver(this.executionFlowGraph,
					this.dataDependencyGraph, this.callGraph);
			Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph> requestIntent = intentCarver
					.carve(startedActivity);
			//
			...
			ResponseIntentCarver responsedIntentCarver = new ResponseIntentCarver(this.executionFlowGraph,
					this.dataDependencyGraph, this.callGraph);
			Triplette<ExecutionFlowGraph, DataDependencyGraph, CallGraph> responseIntent = intentCarver
					.carve(startedActivity);
			//
