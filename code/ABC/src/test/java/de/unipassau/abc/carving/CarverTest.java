...
//			String carveBy = "method=<org.employee.FileRead2: int fileIsRead(java.lang.String,java.lang.String)>";
	...
	public void testCarvingManually() throws IOException, InterruptedException {
		...
		try {
			...
			// "<org.employee.DummyObjectToPassAsParameter: void <init>()>";
			String traceFile = "/Users/gambi/action-based-test-carving/code/scripts/employee-tracingOut/trace.txt";
			String carveBy = "invocation=<org.employee.FileRead2: int fileIsRead(java.lang.String,java.lang.String)>_4497";
			// String carveBy = "package=org.employee";
			// String carveBy = "class=org.employee.FileRead2";
			// String carveBy = "method=<org.employee.FileRead2: int
			// fileIsRead(java.lang.String,java.lang.String)>";
			// String carveBy = "invocation=<org.employee.FileRead2: int
			// fileIsRead(java.lang.String,java.lang.String)>_6108";
			// String carveBy = "invocation=<org.employee.Validation: void
			// <init>()>_54";

			// String carveBy = "method=<org.employee.SeniorSoftwareEngineer:
			// void calcCal()>";
			// String carveBy =
			// "invocation=<org.employee.SeniorSoftwareEngineer: void
			// calcCal()>_1035";
			...
			// String carveBy =
			// "invocation=<org.employee.DummyObjectToPassAsParameter: void
			// <init>()>_40";
			// String carveBy="invocation=<directory.DirectoryDAO:
			// directory.Record\\[\\] runCommand(directory.Command)>_523";
			...
			String[] args = new String[] { "--carve-by", carveBy,
					...
					// "./src/test/resources/Employee-tests.jar",
					...
					"--test-setup-by", "class=org.employee.systemtest.SystemTestUtils",
					// "--reset-environment-by",
					// "directory.DBTrucate.clearDatabase()",
