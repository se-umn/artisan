...
public class TestSoftwareTrainee
{
    @Rule
    ...
    public void test_22() throws Exception {
        ...
        final SoftwareTrainee softwareTrainee = new SoftwareTrainee(file, scanner);
    }
    ...
    public void test_25() throws Exception {
        ...
        final FileWriter fileWriter6 = new FileWriter(new File(file, next), false);
        final FileWriter fileWriter7 = new FileWriter(new File(file, next), false);
        new SoftwareTrainee(file, scanner).calcCal();
    }
    
    public TestSoftwareTrainee() {
