...
public class TestFileHandle_24_minimized {
    ...
    public void test_62() throws Exception {
        ...
        javaiofile01 = new java.io.File(javaiofile02, javalangstring05);
        javaiofileWriter00 = new java.io.FileWriter(javaiofile01, false);
        javaiofile04 = new java.io.File(javaiofile02, javalangstring09);
        javaiofileWriter01 = new java.io.FileWriter(javaiofile04, false);
        javaiofile00 = new java.io.File(javaiofile02, javalangstring09);
        javaiofileWriter04 = new java.io.FileWriter(javaiofile00, false);
        javaiofile03 = new java.io.File(javaiofile02, javalangstring09);
        javaiofileWriter02 = new java.io.FileWriter(javaiofile03, false);
        javaiofile07 = new java.io.File(javaiofile02, javalangstring09);
        javaiofileWriter06 = new java.io.FileWriter(javaiofile07, false);
        javaiofile05 = new java.io.File(javaiofile02, javalangstring09);
        javaiofileWriter05 = new java.io.FileWriter(javaiofile05, false);
        javaiofile06 = new java.io.File(javaiofile02, javalangstring09);
        ...
        javalangstring07 = java.lang.Integer.toString(20);
        orgemployeefileHandle00.addInFile(javalangstring09, javalangstring07);
        javalangstring04 = java.lang.Integer.toString(20);
        orgemployeefileHandle00.addInFile(javalangstring09, javalangstring04);
        javalangstring06 = java.lang.Integer.toString(10);
        orgemployeefileHandle00.addInFile(javalangstring09, javalangstring06);
        javalangstring12 = java.lang.Float.toString(45000.0F);
        orgemployeefileHandle00.addInFile(javalangstring09, javalangstring12);
    }

    public TestFileHandle_24_minimized() {
