...
public class TestFileHandle_11_minimized {
    ...
    public void test_27() throws Exception {
        ...
        javalangstring09 = javaiofile01.getAbsolutePath();
        javalangstringArray00[0] = javalangstring09;
        javalangstring09 = javalangstringArray00[0];
        javaiofile08 = new java.io.File(javalangstring09);
        ...
        javaiofile05 = new java.io.File(javaiofile08, javalangstring03);
        javaiofileWriter02 = new java.io.FileWriter(javaiofile05, false);
        javaiofile02 = new java.io.File(javaiofile08, javalangstring07);
        javaiofileWriter03 = new java.io.FileWriter(javaiofile02, false);
        javaiofile00 = new java.io.File(javaiofile08, javalangstring07);
        javaiofileWriter01 = new java.io.FileWriter(javaiofile00, false);
        javaiofile03 = new java.io.File(javaiofile08, javalangstring07);
        javaiofileWriter04 = new java.io.FileWriter(javaiofile03, false);
        javaiofile06 = new java.io.File(javaiofile08, javalangstring07);
        javaiofileWriter00 = new java.io.FileWriter(javaiofile06, false);
        javaiofile04 = new java.io.File(javaiofile08, javalangstring07);
        javaiofileWriter05 = new java.io.FileWriter(javaiofile04, false);
        javaiofile07 = new java.io.File(javaiofile08, javalangstring07);
        ...
        javalangstring12 = java.lang.Integer.toString(30);
        orgemployeefileHandle00.addInFile(javalangstring07, javalangstring12);
        javalangstring04 = java.lang.Integer.toString(20);
        orgemployeefileHandle00.addInFile(javalangstring07, javalangstring04);
        javalangstring00 = java.lang.Integer.toString(10);
        orgemployeefileHandle00.addInFile(javalangstring07, javalangstring00);
        javalangstring08 = java.lang.Float.toString(96000.0F);
        orgemployeefileHandle00.addInFile(javalangstring07, javalangstring08);
    }

    public TestFileHandle_11_minimized() {
