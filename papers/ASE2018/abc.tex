...
Hotel Reservation & 5 & 128 & 100\% & 41 \% & 29\% & 0.615 & 7.78 & --\\
\end{tabular}
\end{table*}

\begin{table*}
\centering
\caption{Overhead of Test Carving}
\begin{tabular}{l l l l l}
Project name & Size of Trace & carvingTime & testGenerationTime & minimizationTime \\
Employee & 1136 & 16,391 s & 4,225 s & 831,060 \\
Hotel Reservation & 5809 &  6,110 & 7,485 & 3423,924 \\
\end{tabular}
\xxx{Repeat this more time and take the average}
\end{table*}
