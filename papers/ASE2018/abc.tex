...
%%%
%\begin{RQ}
%\textbf{Carving overhead and scalability ?}
% We are not really interested in the practical application of the approach, are we?

% Coverage

% Execution time might or might not be large if we execute ALL the unit tests
